...
INSERT INTO tbl_menu_list(page_id,fk_group_id,fk_app_id,parent_id,link_type,
...
INSERT INTO rbac_role_menu(menu_pid,menu_description,roll_id) VALUES (1609,'Remove Jobs From IPS',1);
...
INSERT INTO rbac_role_menu(menu_pid,menu_description,roll_id) VALUES(1610,'EMS SCAN','1');

	
USE bai_pro3;

create table delete_jobs_log( 
...
alter table cps_log add column reported_status varchar(15) NULL after remaining_qty;

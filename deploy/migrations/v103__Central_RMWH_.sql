...
ALTER TABLE store_in_deleted
  ADD COLUMN barcode_number VARCHAR(255) NULL AFTER split_roll,
  ADD COLUMN ref_tid INT(11) DEFAULT 0 NULL AFTER barcode_number;

USE central_administration_sfcs;

insert into tbl_menu_list (page_id, fk_group_id, fk_app_id, parent_id, link_type, link_status, link_visibility,  link_location, link_description, link_tool_tip, link_cmd) values('SFCS_9021','8','10','179','1','1','1','/sfcs_app/app/warehouse/controllers/scanV2.php','RM Warehouse Material Receive','','');

insert into rbac_role_menu (menu_pid, menu_description, roll_id) values('1594','RM Warehouse Material Receive','1');

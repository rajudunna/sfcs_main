/*1145*/
INSERT INTO `central_administration_sfcs`.`tbl_menu_list` (`menu_id`,`page_id`, `fk_group_id`, `fk_app_id`, `parent_id`, `link_type`, `link_visibility`, `link_location`, `link_description`, `link_tool_tip`, `link_cmd`) VALUES ('1621', 'SFCS_0355', '8', '4', '109', '0', '1', '', 'Schedule Clubbing(Color Level)', '2', ''); 

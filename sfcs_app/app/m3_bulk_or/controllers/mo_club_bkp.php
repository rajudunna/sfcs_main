...
$sql="select * from $table_m3 where $table_m3.club_status='0' and sfcs_style='I00816AA' GROUP BY sfcs_tid order by  sfcs_schedule limit 100";
// echo $sql;
// die();
        ...
        {     
            ...
            { 
                ...
                { 
                    ...
                    $sql_result31=mysqli_query($link, $sql31) or exit("Sql Error--3".mysqli_error($GLOBALS["___mysqli_ston"]));    
            ...
            { 
                ...
                {     
                    ...
                    $sql_result32=mysqli_query($link, $sql122) or exit("Sql Error--3".mysqli_error($GLOBALS["___mysqli_ston"])); 
                    ...
                    { 
                        ...
                        $sql_result32=mysqli_query($link, $sql12) or exit("Sql Error--3".mysqli_error($GLOBALS["___mysqli_ston"])); 
                        if(mysqli_num_rows($sql_result32)>0) 
                        { 
                ...
                { 
                    ...
                    $sql_result31=mysqli_query($link, $sql31) or exit("Sql Error--31".mysqli_error($GLOBALS["___mysqli_ston"])); 
                } 
                        ...
                        { 
                            ...
                            { 
                                ...
                                { 
                                    ...
                                    echo $sql4."<br>"; 
                                    echo "----------------<br>"; 
                                    $sql_result3=mysqli_query($link, $sql4) or exit("Sql Error--3".mysqli_error($GLOBALS["___mysqli_ston"]));                         

	...
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			...
			if(isset($_POST['submit']))
			{
				...
				p.docket_printed_person,p.fabric_status,p.log_update,f.log_user AS req_user,f.log_time,f.req_time,l.date_n_time AS fab_ready_time,f.issued_time,p.order_tid,cat.category,cat.seperate_docket,cat.binding_consumption
				FROM $bai_pro3.plandoc_stat_log p 
				JOIN $bai_pro3.fabric_priorities f ON p.doc_no=f.doc_ref

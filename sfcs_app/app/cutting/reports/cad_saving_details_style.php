...
function firstbox()
{
	window.location.href ="<?php 'index.php?r='.$_GET['r'];  ?>cad_saving_details.php&schedule="+document.test.schedule.value
}

function secondbox()
{
	window.location.href ="<?php 'index.php?r='.$_GET['r']; ?>cad_saving_details.php&schedule="+document.test.schedule.value+"&color="+document.test.color.value
}

function thirdbox()
{
	window.location.href ="<?php 'index.php?r='.$_GET['r']; ?>cad_saving_details.php&schedule="+document.test.schedule.value+"&color="+document.test.color.value+"&category="+document.test.category.value
...
echo "
	...
	$sql="select compo_no,tid,catyy,gmtway,purwidth from $bai_pro3.cat_stat_log where order_tid = '$order_tid' and category='$category'";
	...
	$docketnos[]=-1;
	$docketno[]=-1;
	$sql="select doc_no from $bai_pro3.plandoc_stat_log where order_tid = '$order_tid' and cat_ref=\"$cat_ref\" and fabric_status=\"5\"";
	...
	$recut_docketnos[]=-1;
	$recut_docketno[]=-1;
	$sql="select doc_no from $bai_pro3.recut_v2 where order_tid = '$order_tid' and cat_ref=\"$cat_ref\"";

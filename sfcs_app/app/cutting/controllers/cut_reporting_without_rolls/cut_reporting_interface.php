...
//    });
    ...
    function calculatecutreport(indextype)
    {
        ...
        fabricreturnqty = parseFloat(receivedqty - ((reportingplies*mlength) + endbits + shortages)).toFixed(2);

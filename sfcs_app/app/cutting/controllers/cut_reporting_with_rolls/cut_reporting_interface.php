...
<div class='panel panel-primary cut_tab'>
    ...
    <div class='panel-body'>  
        ...
        <div class='col-sm-12' id='roll_wise_info'>
...
//Rejection Panel Code Ends
    ...
    function load_details(doc_no){
        ...
        $.ajax({
            ...
            if(res == '0'){
                $('#roll_wise_info').html('Roll Information was not Updated.You Cannot Report the CUT');
                $('#submit').css({'display':'none'});
            }else
                $('#roll_wise_info').html(res);
        }).fail(function(){
            $('#roll_wise_info').html('Roll Information was not Updated.You Cannot Report the CUT');
            $('#submit').css({'display':'none'});
            swal('Rolls Information was not Updated','','error');
        });
    }
</script>

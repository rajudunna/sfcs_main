...
<script src="<?= '../'.getFullURLLevel($_GET['r'],'common/js/jquery-1.3.2.js',2,'R')?>">
</script>
...
">
  ...
  src="<?= getFullURL($_GET['r'],'../../common/images/Book1_29570_image003_v2.png','r');?>" alt=LOGO v:shapes="Text_x0020_Box_x0020_13 Picture_x0020_14"></span><![endif]><span

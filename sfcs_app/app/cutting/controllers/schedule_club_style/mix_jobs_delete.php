...
{ 
    ...
    {     
        ...
        // echo $sql4528123."<br>"; 
        $sql_result4528=mysqli_query($link, $sql4528123) or exit("Sql Error".mysqli_error($GLOBALS["___mysqli_ston"])); 
        ...
        // echo $sql4529123."<br>"; 
        $sql_result4529=mysqli_query($link, $sql4529123) or exit("Sql Error".mysqli_error($GLOBALS["___mysqli_ston"])); 
         
        $sql45229="DELETE from $bai_pro3.cat_stat_log where order_tid like \"%".$schedule.$color."%\""; 
        // echo $sql4529."<br>"; 
        $sql_result45229=mysqli_query($link, $sql45229) or exit("Sql Error".mysqli_error($GLOBALS["___mysqli_ston"])); 
        ...
        // echo $sql4529."<br>"; 
        $sql_result452291=mysqli_query($link, $sql452291) or exit("Sql Error".mysqli_error($GLOBALS["___mysqli_ston"])); 
        ...
        // echo $sql451."<br>"; 
        $sql_result451=mysqli_query($link, $sql4521) or exit("Sql Error".mysqli_error($GLOBALS["___mysqli_ston"])); 

...
<div class="panel-heading">Cut Docket Prints</div>
...
if($flag == 1)
{
	echo "<tr class='tblheading'><th>DOCID</th><th>CUTNO</th>";
...
else
{
	echo "<tr class='tblheading'>
		  ...
		  <th>26</th><th>27</th><th>28</th><th>29</th><th>30</th><th>31</th><th>32</th><th>33</th><th>34</th><th>35</th><th>36</th><th>37</th><th>38</th><th>39</th><th>40</th><th>41</th><th>42</th><th>43</th><th>44</th><th>45</th><th>46</th><th>47</th><th>48</th><th>49</th><th>50</th><th>PLIES</th><th>Controls</th>";
}


if($rev_check=="T") { echo "<th style='display:none;'>Review Sheets</th>";}
echo "</tr>";
...
$color_code=$sql_row33['color_code']; //Color Code
	...
	*/
	...
	//echo "<td><a href=\"$path\" onclick=\"return popitup("."'".$path."')\">View</a></td>";

	if($bgcol=="Original")
	{
		
	echo "<td><a href=\"$path\" class=\"btn btn-primary\" onclick=\"return popitup("."'".$path."')\">$bgcol Print</a></td>";
	}
	else
	{
			echo "<td><a href=\"$path\" class=\"btn btn-primary\" onclick=\"return popitup("."'".$path."')\">$bgcol Print</a></td>";

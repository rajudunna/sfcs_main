...
<?php 
    ...
    { 
        ...
        $cut_waste=$sql_row['cuttable_wastage'];
    } 
    ...
    $sql22="select marker_length as mklength from $bai_pro3.marker_ref_matrix where  cat_ref=".$sql_row2['cat_ref']." and allocate_ref=".$sql_row2['allocate_ref']; 
    //echo $sql22; 

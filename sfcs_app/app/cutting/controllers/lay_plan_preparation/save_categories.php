        ...
        while($sql_row1=mysqli_fetch_array($sql_result1))
        {
            ...
            if($sql_row1['tid']!=$cat_id) 
            {
                ...
                if($num_cnt == 0)
                {
                    ...
                    values (".$sql_row1['tid'].", ".$ct.", '$tran_order_tid', '$ratio', '$cutnos', '$in_s01' ,'$in_s02' ,'$in_s03' ,'$in_s04' ,'$in_s05' ,'$in_s06' ,'$in_s07' ,'$in_s08' ,'$in_s09' ,'$in_s10' ,'$in_s11' ,'$in_s12' ,'$in_s13' ,'$in_s14' ,'$in_s15' ,'$in_s16' ,'$in_s17' ,'$in_s18' ,'$in_s19' ,'$in_s20' ,'$in_s21' ,'$in_s22' ,'$in_s23' ,'$in_s24' ,'$in_s25' ,'$in_s26' ,'$in_s27' ,'$in_s28' ,'$in_s29' ,'$in_s30' ,'$in_s31' ,'$in_s32' ,'$in_s33' ,'$in_s34' ,'$in_s35' ,'$in_s36' ,'$in_s37' ,'$in_s38' ,'$in_s39' ,'$in_s40' ,'$in_s41' ,'$in_s42' ,'$in_s43' ,'$in_s44' ,'$in_s45' ,'$in_s46' ,'$in_s47' ,'$in_s48' ,'$in_s49' ,'$in_s50', '$plies', \"$remarks\", '$pliespercut')";

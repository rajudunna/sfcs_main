...
bai_pro3.bai_orders_db_confirm.bts_status
  ...
  $query2=substr($plandoc_stat_log,0,-1);
	...
	$sizesMasterQuery="select id,upper(size_name) as size_name from $bai_pro3.tbl_orders_size_ref order by size_name";
	...
	if($check1>0)
	{
		while($r=mysqli_fetch_array($result))
		{
			...
			else
			{
				...
				$default_operations="SELECT id FROM $bai_pro3.tbl_orders_ops_ref where default_operation='YES'";
      ...
      if($color_query>0 or $color_query==0)
			{
				...
				if($r['order_s_s01']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s01_id,'".$title_size_s01."',".$r['order_s_s01'].",".$r['old_order_s_s01'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s02']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s02_id,'".$title_size_s02."',".$r['order_s_s02'].",".$r['old_order_s_s02'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s03']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s03_id,'".$title_size_s03."',".$r['order_s_s03'].",".$r['old_order_s_s03'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s04']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s04_id,'".$title_size_s04."',".$r['order_s_s04'].",".$r['old_order_s_s04'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s05']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s05_id,'".$title_size_s05."',".$r['order_s_s05'].",".$r['old_order_s_s05'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s06']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s06_id,'".$title_size_s06."',".$r['order_s_s06'].",".$r['old_order_s_s06'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s07']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s07_id,'".$title_size_s07."',".$r['order_s_s07'].",".$r['old_order_s_s07'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s08']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s08_id,'".$title_size_s08."',".$r['order_s_s08'].",".$r['old_order_s_s08'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s09']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s09_id,'".$title_size_s09."',".$r['order_s_s09'].",".$r['old_order_s_s09'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s10']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s10_id,'".$title_size_s10."',".$r['order_s_s10'].",".$r['old_order_s_s10'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s11']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s11_id,'".$title_size_s11."',".$r['order_s_s11'].",".$r['old_order_s_s11'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s12']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s12_id,'".$title_size_s12."',".$r['order_s_s12'].",".$r['old_order_s_s12'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s13']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s13_id,'".$title_size_s13."',".$r['order_s_s13'].",".$r['old_order_s_s13'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s14']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s14_id,'".$title_size_s14."',".$r['order_s_s14'].",".$r['old_order_s_s14'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s15']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s15_id,'".$title_size_s15."',".$r['order_s_s15'].",".$r['old_order_s_s15'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s16']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s16_id,'".$title_size_s16."',".$r['order_s_s16'].",".$r['old_order_s_s16'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s17']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s17_id,'".$title_size_s17."',".$r['order_s_s17'].",".$r['old_order_s_s17'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s18']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s18_id,'".$title_size_s18."',".$r['order_s_s18'].",".$r['old_order_s_s18'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s19']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s19_id,'".$title_size_s19."',".$r['order_s_s19'].",".$r['old_order_s_s19'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s20']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s20_id,'".$title_size_s20."',".$r['order_s_s20'].",".$r['old_order_s_s20'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s21']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s21_id,'".$title_size_s21."',".$r['order_s_s21'].",".$r['old_order_s_s21'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s22']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s22_id,'".$title_size_s22."',".$r['order_s_s22'].",".$r['old_order_s_s22'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s23']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s23_id,'".$title_size_s23."',".$r['order_s_s23'].",".$r['old_order_s_s23'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s24']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s24_id,'".$title_size_s24."',".$r['order_s_s24'].",".$r['old_order_s_s24'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s25']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s25_id,'".$title_size_s25."',".$r['order_s_s25'].",".$r['old_order_s_s25'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s26']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s26_id,'".$title_size_s26."',".$r['order_s_s26'].",".$r['old_order_s_s26'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s27']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s27_id,'".$title_size_s27."',".$r['order_s_s27'].",".$r['old_order_s_s27'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s28']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s28_id,'".$title_size_s28."',".$r['order_s_s28'].",".$r['old_order_s_s28'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s29']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s29_id,'".$title_size_s29."',".$r['order_s_s29'].",".$r['old_order_s_s29'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s30']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s30_id,'".$title_size_s30."',".$r['order_s_s30'].",".$r['old_order_s_s30'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s31']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s31_id,'".$title_size_s31."',".$r['order_s_s31'].",".$r['old_order_s_s31'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s32']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s32_id,'".$title_size_s32."',".$r['order_s_s32'].",".$r['old_order_s_s32'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s33']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s33_id,'".$title_size_s33."',".$r['order_s_s33'].",".$r['old_order_s_s33'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s34']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s34_id,'".$title_size_s34."',".$r['order_s_s34'].",".$r['old_order_s_s34'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s35']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s35_id,'".$title_size_s35."',".$r['order_s_s35'].",".$r['old_order_s_s35'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s36']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s36_id,'".$title_size_s36."',".$r['order_s_s36'].",".$r['old_order_s_s36'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s37']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s37_id,'".$title_size_s37."',".$r['order_s_s37'].",".$r['old_order_s_s37'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s38']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s38_id,'".$title_size_s38."',".$r['order_s_s38'].",".$r['old_order_s_s38'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s39']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s39_id,'".$title_size_s39."',".$r['order_s_s39'].",".$r['old_order_s_s39'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s40']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s40_id,'".$title_size_s40."',".$r['order_s_s40'].",".$r['old_order_s_s40'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s41']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s41_id,'".$title_size_s41."',".$r['order_s_s41'].",".$r['old_order_s_s41'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s42']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s42_id,'".$title_size_s42."',".$r['order_s_s42'].",".$r['old_order_s_s42'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s43']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s43_id,'".$title_size_s43."',".$r['order_s_s43'].",".$r['old_order_s_s43'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s44']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s44_id,'".$title_size_s44."',".$r['order_s_s44'].",".$r['old_order_s_s44'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s45']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s45_id,'".$title_size_s45."',".$r['order_s_s45'].",".$r['old_order_s_s45'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s46']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s46_id,'".$title_size_s46."',".$r['order_s_s46'].",".$r['old_order_s_s46'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s47']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s47_id,'".$title_size_s47."',".$r['order_s_s47'].",".$r['old_order_s_s47'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s48']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s48_id,'".$title_size_s48."',".$r['order_s_s48'].",".$r['old_order_s_s48'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s49']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s49_id,'".$title_size_s49."',".$r['order_s_s49'].",".$r['old_order_s_s49'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			if($r['order_s_s50']>0)
				{
				 ...
				 $insertSizesQuery="INSERT INTO $bai_pro3.tbl_orders_sizes_master(parent_id, ref_size_name, size_title, order_quantity, order_act_quantity,order_col_des) VALUES ($order_id,$s50_id,'".$title_size_s50."',".$r['order_s_s50'].",".$r['old_order_s_s50'].",'".$color_code."')";
				 $result6=mysqli_query($link, $insertSizesQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));
			...
			$layPlanQuery="SELECT plandoc_stat_log.*,cat_stat_log.category FROM $bai_pro3.bai_pro3.plandoc_stat_log as plandoc_stat_log
			...
			while($l=mysqli_fetch_array($result7))
			{
				...
				$insertLayPlanQuery="INSERT INTO $bai_pro3.tbl_cut_master(doc_num,ref_order_num,cut_num,cut_status,planned_module,request_time,issued_time,planned_plies,actual_plies,plan_date,style_id,product_schedule,cat_ref,cuttable_ref,mk_ref,col_code) VALUES
				...
				if($l['p_s01']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s01_id.",".$l['p_s01'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s02']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s02_id.",".$l['p_s02'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s03']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s03_id.",".$l['p_s03'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s04']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s04_id.",".$l['p_s04'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s05']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s05_id.",".$l['p_s05'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s06']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s06_id.",".$l['p_s06'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s07']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s07_id.",".$l['p_s07'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s08']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s08_id.",".$l['p_s08'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s09']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s09_id.",".$l['p_s09'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s10']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s10_id.",".$l['p_s10'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s11']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s11_id.",".$l['p_s11'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s12']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s12_id.",".$l['p_s12'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s13']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s13_id.",".$l['p_s13'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s14']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s14_id.",".$l['p_s14'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s15']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s15_id.",".$l['p_s15'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s16']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s16_id.",".$l['p_s16'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s17']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s17_id.",".$l['p_s17'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s18']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s18_id.",".$l['p_s18'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s19']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s19_id.",".$l['p_s19'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s20']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s20_id.",".$l['p_s20'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s21']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s21_id.",".$l['p_s21'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s22']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s22_id.",".$l['p_s22'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s23']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s23_id.",".$l['p_s23'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s24']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s24_id.",".$l['p_s24'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s25']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s25_id.",".$l['p_s25'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s26']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s26_id.",".$l['p_s26'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s27']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s27_id.",".$l['p_s27'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s28']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s28_id.",".$l['p_s28'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s29']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s29_id.",".$l['p_s29'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s30']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s30_id.",".$l['p_s30'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s31']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s31_id.",".$l['p_s31'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s32']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s32_id.",".$l['p_s32'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s33']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s33_id.",".$l['p_s33'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s34']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s34_id.",".$l['p_s34'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s35']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s35_id.",".$l['p_s35'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s36']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s36_id.",".$l['p_s36'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s37']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s37_id.",".$l['p_s37'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s38']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s38_id.",".$l['p_s38'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s39']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s39_id.",".$l['p_s39'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s40']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s40_id.",".$l['p_s40'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s41']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s41_id.",".$l['p_s41'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s42']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s42_id.",".$l['p_s42'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s43']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s43_id.",".$l['p_s43'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s44']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s44_id.",".$l['p_s44'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s45']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s45_id.",".$l['p_s45'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s46']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s46_id.",".$l['p_s46'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s47']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s47_id.",".$l['p_s47'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s48']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s48_id.",".$l['p_s48'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s49']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s49_id.",".$l['p_s49'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

					}
				if($l['p_s50']>0)
					{
					 $insertLayplanItemsQuery="INSERT INTO $bai_pro3.tbl_cut_size_master(color,parent_id,ref_size_name,quantity) VALUES ('".$color_code."',".$layplan_id.",".$s50_id.",".$l['p_s50'].")";
					 $result9=mysqli_query($link, $insertLayplanItemsQuery) or ("Sql error".mysqli_error($GLOBALS["___mysqli_ston"]));

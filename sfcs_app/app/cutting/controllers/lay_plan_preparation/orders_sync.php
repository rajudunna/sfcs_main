...
<?php
	...
	while($r=mysqli_fetch_array($result))
	{
		...
		for ($i=0; $i < sizeof($sizes_array); $i++)
		{
			...
			{
				//$temp1=$r[$test];
				$sql1113="select parent_id,order_col_des,ref_size_name from $brandix_bts.tbl_orders_sizes_master where parent_id=$order_id and order_col_des='".$color_code."' and ref_size_name='".$sizes_tmp[$i]."'";

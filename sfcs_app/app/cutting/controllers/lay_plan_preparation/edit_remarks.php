		...
		<form name="test" method="post" action="<?php echo getFullURL($_GET['r'], "edit_remarks.php", "N"); ?>">
			<div class="row">
				<div class="col-sm-4" style="display:none;"><label>Remarks : </label>
					<input type="textarea" class="form-control" rows="1" name="rem" value="<?= $_GET['remarks_x']?>">
				</div>
...
if(isset($_POST['submit']))
{
	...
	$sql1111="select order_tid from $bai_pro3.bai_orders_db_remarks where order_tid=\"$o_tid\"";

...
if(isset($_POST['update']))
{
	...
	$allocate_ref=$_POST['allocate_ref'];
		...
		{
                $sql_check="select cat_ref,order_tid from $bai_pro3.maker_stat_log where cat_ref=$cat_ref and order_tid=\"$tran_order_tid\"";
				...
				for($i=0; $i<$row_count; $i++)
				{
					...
					if($in_skgrp != '' && $in_width != '' && $in_mklen && $in_mkver != '') {
						...
						$sql_check1="select parent_id from $bai_pro3.maker_details where parent_id=$allocate_ref";

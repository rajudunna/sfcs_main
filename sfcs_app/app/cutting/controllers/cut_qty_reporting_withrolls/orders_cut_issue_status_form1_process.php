				...
				if($docket_num_check>0){
					...
					if($location_num_check >= 0){
						...
						if($total < $emptyqty[0]){
							...
							$sql1113_result=mysqli_query($link, $sql1113) or exit("Sql Error1112".mysqli_error($GLOBALS["___mysqli_ston"]));

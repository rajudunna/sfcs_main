...
<form method="post" name="input" action="<?php echo getFullURL($_GET['r'],'doc_track_panel.php','N'); ?>">
<div class="row">
<div class="col-md-3">
...
//echo "<td>$remarks</td>";
	...
	if($category=='Body' or $category=="Front")
	{
		...
		//{
			...
			{
				$url = getFullURL($_GET['r'],'orders_cut_issue_status_form1.php','N');
...
{
	echo "<script>sweetAlert('Please enter valid Docket Reference','','error');</script>";

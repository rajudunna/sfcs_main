	...
	<div class="panel-body">
		...
		if(isset($_POST['submit']) or isset($_GET['ref']))
		{
			try
			{
				...
				$sql1="select lot_no,rec_no,item,item_name,item_desc,inv_no,po_no,rec_qty,batch_no,product_group,uom,pkg_no,grn_date from $wms.sticker_report where (inv_no=\"".$ref."\" or po_no=\"".$ref."\" or batch_no=\"".$ref."\" or product_group=\"$ref\") and plant_code=\"".$plant_code."\"";
				//echo $sql1;

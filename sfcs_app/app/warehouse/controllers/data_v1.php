								...
								$res_get_data_fm_cwh1 = $link->query($qry_get_data_fm_cwh1);
								 while($row15 = $res_get_data_fm_cwh1->fetch_assoc()) 
									...
									if(count($sticker_data)==0){
										...
										$sticker_data_query="INSERT INTO $bai_rm_pj1.`sticker_report` (`item`,`item_name`,`item_desc`,`inv_no`,`po_no`,`rec_no`,`lot_no`,`batch_no`,`buyer`,`product_group`,`doe`,`pkg_no`,`grn_date`,`allocated_qty`,`backup_status`,`supplier`,`uom`,`grn_location`,rec_qty) VALUES ('".$sticker_data3['item']."','".$sticker_data3['item_name']."','".$sticker_data3['item_desc']."','".$sticker_data3['inv_no']."','".$sticker_data3['po_no']."','".$sticker_data3['rec_no']."','".$sticker_data3['lot_no']."','".$sticker_data3['batch_no']."','".$sticker_data3['buyer']."','".$sticker_data3['product_group']."','".$sticker_data3['doe']."','".$sticker_data3['pkg_no']."','".$sticker_data3['grn_date']."','".$sticker_data3['allocated_qty']."','".$sticker_data3['backup_status']."','".$sticker_data3['supplier']."','".$sticker_data3['uom']."','".$plant_name."','".$total."')";

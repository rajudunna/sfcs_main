...
$countqry="select count(*) as cnt from $wms.inspection_complaint_db where reject_batch_no = \"".$batch_no."\" OR reject_inv_no=\"".$batch_no."\" and plant_code='".$plant_code."'";
...
while ($row1=mysqli_fetch_array($count))
{
	...
	if($count_res>0)
	{
		...
		echo "</tr></thead>";
		$sql11="select * from $wms.inspection_complaint_db where reject_batch_no = \"".$batch_no."\" OR reject_inv_no=\"".$batch_no."\" and plant_code='".$plant_code."'";

...
if(mysqli_num_rows($sql_result) > 0){
    ...
    while($sql_row=mysqli_fetch_array($sql_result))
    {
       ...
       // echo $sql1."<br>";
        ...
        $j=0;
        $t=0;
        $sql1x="select distinct batch_no as batch_no,month(grn_date) as mnt from $wms.sticker_report WHERE DATE(grn_date) BETWEEN \"".$sdate."\" AND \"".$edate."\" ".$add_query." AND product_group=\"Fabric\" and supplier=\"".$supplier_name."\" and plant_code='".$plant_code."' group by month(grn_date),batch_no";
        // echo $sql1x."<br>";
        ...
        {   
            ...
            $sql_fet="select * from $wms.supplier_performance_track where tid=\"".trim($batch_ref)."-".$mnt."\" and plant_code='".$plant_code."'";
            //echo $sql_fet."<br>";
            ...
            {
                $sql3l="select * from $wms.store_in WHERE lot_no IN (".$lots_ref.") and plant_code='".$plant_code."'";
                // echo $sql3l."<br>";
                ...
                if($rows_count > 0)
                {
                    ...
                    $sql4l="select SUM(qty_rec) AS tktlen,SUM(ref5) AS ctexlen from $wms.store_in WHERE lot_no IN (".$lots_ref.") and plant_code='".$plant_code."'"; 
                    // echo $sql4l."<br>";
            ...
            if(sizeof($com_ref1) > 0)
            {
                ...
                {                   
                    if($i3<2)
                    {
                        ...
                        $sql33="select complaint_reason as res from $wms.inspection_complaint_reasons where complaint_category=\"Fabric\" and sno=\"".$reason_ref_explode_ex[0]."\" and plant_code='".$plant_code."'";
                        //echo $sql33."</br>";

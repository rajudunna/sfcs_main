...
if(mysqli_num_rows($sql_result) > 0){
    ...
    while($sql_row=mysqli_fetch_array($sql_result))
    {
        ...
        {   
            ...
            $sql2l="select date(log_date) as dat,consumption,act_gsm,pur_gsm,pur_width,act_width,qty_insp,unique_id,pts,fallout,skew_cat,skew,shrink_l, shrink_w, date(log_date) as entdate,status from $pps.inspection_db where batch_ref=\"".$batch_ref."\"";
            // echo $sql2l."<br>";

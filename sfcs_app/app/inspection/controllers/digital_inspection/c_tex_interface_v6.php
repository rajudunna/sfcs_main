...
if(isset($_POST['put']) || isset($_POST['confirm']))
{
	...
	if($head_check>0)
	{
		...
		{	
			...
			$sql="insert into $wms.inspection_db(batch_ref_id,batch_ref,plant_code,created_user,created_at,updated_user,updated_at) values (\"$uuid\",\"$lot_no_new\",'".$plant_code."','$username',NOW(),'$username',NOW())";

...
$recut_doc_db=array();
$qty=array();
$sql="select cutno, round(sum(qty_issued),2) as material_req from $wms.store_out where tran_tid=\"".$temp[0]."\" and plant_code='".$plant_code."' and length(cutno)>0 group by cutno";

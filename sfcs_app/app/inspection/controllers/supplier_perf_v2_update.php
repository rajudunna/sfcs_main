...
if(isset($_POST['update']))
{
	...
	for($i=1;$i<=sizeof($reason_name);$i++)
	{
		...
		$sql_result11=mysqli_query($link, $sql11) or exit("Sql Error at 108 line".$sql1.mysqli_error($GLOBALS["___mysqli_ston"]));
		//echo $sql11;
		...
		if($string_include1[$i]!=''){
			//$string_include1= $str = str_replace('"','\"',$string_include1[$i]);;
		}else{
			$string_include1=0;
		}
		...
		//echo $sql1."<br>";
		$sql_result1=mysqli_query($link, $sql1) or exit("Sql Error at 146".$sql1.mysqli_error($GLOBALS["___mysqli_ston"]));

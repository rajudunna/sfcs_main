...
<table border=0 cellpadding=0 cellspacing=0 width=1126 class=xl11024082 style='border-collapse:collapse;table-layout:fixed;width:1050pt'>
 ...
 <tr height=26 style='mso-height-source:userset;height:20.1pt'>
  <td height=26 class=xl9524082 dir=LTR width=80 style='height:20.1pt;  width:60pt'>Buyer</td>
  <td colspan=2 class=xl9624082 dir=LTR width=130 style='border-left:none;  width:98pt'><?php echo $buyer; ?></td>
 ...
 <tr height=26 style='mso-height-source:userset;height:20.1pt'>
  ...
  border-top:none;width:60pt'>Item Code</td>
  <td colspan=9 class=xl9324082 dir=LTR  style='border-left:none;'><?php echo $item; ?></td>
 ...
 <tr height=26 style='mso-height-source:userset;height:20.1pt'>
  ...
  width:109pt'><?php if(in_array($username,$auth_to_modify)) { echo "<input onchange=\"change_head(1,this.name)\" type=\"number\" step=\"any\" min=\"0\" class=\"textbox\" id=\"pts\" name=\"pts\" value='".$pts."' />"; } else { echo $pts; }?></td>
  <td colspan=2 class=xl9324082 dir=LTR width=136 style='border-left:none;
 ...
 <tr height=26 style='mso-height-source:userset;height:20.1pt'>
  ...
  border-left:none;width:96pt'><?php if(in_array($username,$auth_to_modify)) { echo '<input onchange="change_head(1,this.name)"  type="number" step="any" class="textbox" id="qty_insp" name="qty_insp" min="0" min="0" value="'.$qty_insp.'" >'; } else { echo $qty_insp; }?></td>
  <td class=xl9424082 dir=LTR width=99 style='border-top:none;border-left:none;
  width:74pt'>Fallout</td>
  <td colspan=2 class=xl10324082 dir=LTR width=145 style='border-right:.5pt solid black;
  width:109pt'><?php if(in_array($username,$auth_to_modify)) { echo '<input onchange="change_head(1,this.name)"  type="number" step="any" class="textbox" id="fallout" name="fallout" min="0" value="'.$fallout.'" >'; } else { echo $fallout; }?></td>
  
  <td colspan=2 class=xl9324082 dir=LTR width=136 style='border-left:none;width:102pt'>Pur. GSM</td>
  <td class=xl9324082 dir=LTR style='border-left:none; width:102pt'><?php if(in_array($username,$auth_to_modify)) { echo '<input onchange="change_head(1,this.name)" size=4  type="number" step="any" class="textbox" id="pur_gsm" name="pur_gsm" min="0"  value="'.$pur_gsm.'" style="width: 64px;">'; } else { echo $pur_gsm; }?></td>
  <td colspan=2 class=xl9324082 dir=LTR width=136 style='border-left:none; style="align:center;" width:102pt'>Act. GSM</td>
  <td colspan=1 class=xl9324082 dir=LTR width=136 style='border-left:none; width:102pt'><?php if(in_array($username,$auth_to_modify)) { echo '<input onchange="change_head(1,this.name)" size=4 type="number" step="any" class="textbox" id="act_gsm" name="act_gsm" min="0"  value="'.$act_gsm.'" style="width: 64px;" >'; } else { echo $act_gsm; }?></td>
 </tr>
 <tr height=26 style='mso-height-source:userset;height:20.1pt'>
  <td height=26 class=xl9724082 dir=LTR width=80 style='height:20.1pt;
 ...
 else
 {
  ...
  width:109pt'><?php if(in_array($username,$auth_to_modify)) { echo '<input onchange="change_head(1,this.name)"  type="number" step="any" class="textbox" id="skew" name="skew" value="'.$skew.'" />'; } else { echo $skew; } ?></td>
  <td colspan=2 class=xl9324082 dir=LTR width=136 style='border-left:none;
  width:102pt'>Purchase Width</td>
  <td colspan=4 class=xl9324082 dir=LTR width=272 style='border-right:1.0pt solid black;
  border-left:none;width:204pt'><?php if(in_array($username,$auth_to_modify)) { echo '<input onchange="change_head(1,this.name)"  type="number" step="any"  class="textbox" id="pur_width" name="pur_width" value="'.$pur_width.'" />';} else { echo $pur_width; } ?></td>
 </tr>
 <tr height=26 style='mso-height-source:userset;height:20.1pt'>
 ...
 else
 {
    ...
    ?></td>
  <td class=xl11324082 style='border-top:none;border-left:none;'><?php if(in_array($username,$auth_to_modify)) { echo '<input onchange="change_head(1,this.name)"  type="number" step="any" class="textbox" name="shrink_l" id="shrink_l" min="0" value="'.$shrink_l.'" style="width: 67px;"/>';  } else { echo $shrink_l; } ?> </td>
  <td class=xl11424082 style='border-top:none;border-left:none' ><?php if(in_array($username,$auth_to_modify)) { echo '<input onchange="change_head(1,this.name)"  type="number" step="any" class="textbox" name="shrink_w" id="shrink_w" min="0" value="'.$shrink_w.'" style="width: 67px;" />';  } else { echo $shrink_w; } ?> </td>

...
$username = $_SESSION['userName'];
	...
	$sqla="select * from $wms.supplier_performance_track where DATE(grn_date) between \"".$sdate."\" AND \"".$edate."\" AND plant_code='".$plant_code."'";

...
<?php
	...
	$sqla="select * from $wms.supplier_performance_track where DATE(grn_date) between \"".$sdate."\" AND \"".$edate."\"";
	...
	$sql2c="select * from $wms.supplier_performance_track where DATE(grn_date) between \"".$sdate."\" AND \"".$edate."\" AND impact=\"Yes\"";

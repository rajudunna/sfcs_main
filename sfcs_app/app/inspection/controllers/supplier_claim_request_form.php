...
if(isset($_POST['submitx']))
{
	...
	for($i=0;$i<sizeof($rej_com_sno);$i++)
	{
		if($rej_ind_qty[$i] > 0)
		{
			$sql9="insert into $wms.inspection_complaint_db_log(complaint_track_id,complaint_reason,complaint_rej_qty,complaint_rating,complaint_commnets,plant_code,created_user,updated_user,updated_at) values(\"".$max_complaint_no."\",\"".$rej_com_sno[$i]."\",\"".$rej_ind_qty[$i]."\",\"".$rej_ind_rat[$i]."\",\"".$rej_ind_remarks[$i]."\",'".$plant_code."','".$username."','".$username."',NOW())";

...
for($i=0;$i<$shade_count;$i++)
  {
  	$sql_sc="select count(*) as cnt from $wms.store_in where plant_code='$plantcode' and lot_no in ($lot_ref) and ref4=\"".$scount_temp2[$i]."\"";

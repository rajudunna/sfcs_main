...
// echo $sql;
$result=mysqli_query($link, $sql) or die("NO data Found".mysqli_error($GLOBALS["___mysqli_ston"]));
...
echo "<input type='button' value='Print' class='btn btn-warning' onclick='printscreen()'>";
echo "<br/>";

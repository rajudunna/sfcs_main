...
<?php
		...
		$toggle=0;
		$sql="select distinct rand_track from ims_log where ims_mod_no='$module_ref' $add_query order by tid";
		//echo $sql;
		...
		while($sql_row=mysqli_fetch_array($sql_result))
		{
			...
			$req_date="";
			$sql12="select req_date from ims_exceptions where ims_rand_track=$rand_track";
			...
			$sql12="select * from ims_log where ims_mod_no=$module_ref and rand_track=$rand_track and ims_status<>\"DONE\" order by ims_schedule, ims_size DESC";
			mysqli_query($link, $sql12) or exit("Sql Error".mysqli_error($GLOBALS["___mysqli_ston"]));
			$sql_result12=mysqli_query($link, $sql12) or exit("Sql Error".mysqli_error($GLOBALS["___mysqli_ston"]));
			while($sql_row12=mysqli_fetch_array($sql_result12))
			{

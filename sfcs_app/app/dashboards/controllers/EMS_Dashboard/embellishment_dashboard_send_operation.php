...
foreach ($workstations as $emb_key => $emb_value) {
  ...
  foreach ($task_job_ids as $task_job_id => $task_header_id_j) {
    ...
    $task_job_trans = "SELECT * FROM $tms.task_job_transactions where task_jobs_id ='$task_job_id' and job_group=".DepartmentTypeEnum::EMBELLISHMENT." order by operation_seq ASC limit 0,1";

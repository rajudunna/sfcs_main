...
while($sql_rowx=mysqli_fetch_array($sql_resultx))
{
  ...
  {   
    ...
    $blink_minimum=0;
    {
      ...
      $req_date_time[]=0;
      $track_ids = [];
      $sql2="select track_id,doc_no,module from $bai_pro3.embellishment_plan_dashboard where module in ($section_mods) and orginal_qty<>send_qty and short_shipment_status=0 order by log_time,module";
      ...
      $main_color = color_encode($color);
          ...
          if($orginal_qty<$send_qty || $send_qty<$receive_qty)
          {
            $id="red";
          }
          ...
          if($sql_row1['clubbing']>0)
          {
            $total_qty=0;
            $fabric_required=0;
            $sql11="select order_col_des,color_code,doc_no,material_req,remarks,(p_xs+p_s+p_m+p_l+p_xl+p_xxl+p_xxxl+p_s01+p_s02+p_s03+p_s04+p_s05+p_s06+p_s07+p_s08+p_s09+p_s10+p_s11+p_s12+p_s13+p_s14+p_s15+p_s16+p_s17+p_s18+p_s19+p_s20+p_s21+p_s22+p_s23+p_s24+p_s25+p_s26+p_s27+p_s28+p_s29+p_s30+p_s31+p_s32+p_s33+p_s34+p_s35+p_s36+p_s37+p_s38+p_s39+p_s40+p_s41+p_s42+p_s43+p_s44+p_s45+p_s46+p_s47+p_s48+p_s49+p_s50)*p_plies as total from $bai_pro3.order_cat_doc_mk_mix where order_del_no='$schedule' and clubbing=".$sql_row1['clubbing']." and acutno=".$sql_row1['acutno'];

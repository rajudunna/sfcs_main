...
<<<<<<< HEAD
  <td colspan=6 rowspan=3 class=xl8217319x valign="top" align="left"><img src="/sfcs_app/common/images/logo.png" width="200" height="60"></td><span
=======
  <td colspan=6 rowspan=3 class=xl8217319x valign="top" align="left"><img src="<?= $logo  ?>" width="200" height="60"></td><span
>>>>>>> 921-for-new-logos
...
<tr class=xl674118 height=20 style='mso-height-source:userset;height:15.0pt'>
  ...
  <td rowspan=2 class=xl1144118 width=64 style='border-bottom:.5pt solid black;  width:48pt'>Binding<br/>Length</td>  
...
if(sizeof($roll_det)>0)
 {
	for($i=0;$i<sizeof($roll_det);$i++){
		...
		<tr class=xl654118 height=30 style='mso-height-source:userset;height:30pt'>
			...
			<td class=xl814118 style='text-align:center;padding-bottom:5pt;'>&nbsp;</td>
			<td colspan=1 class=xl684118 style='text-align:right;padding-bottom:5pt;'><?php echo round(($ctex_width[$i]-$tkt_width[$i]),2); $tot_bind_len=$tot_bind_len+($ctex_width[$i]-$tkt_width[$i]);
			?></td>

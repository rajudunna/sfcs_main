...
echo "SELECT SUM(ord_qty_new),SUM(output) FROM week_delivery_plan_ref WHERE ex_factory_date_new=\"$monday\"";
...
//echo "SELECT SUM(ord_qty_new),SUM(output) FROM week_delivery_plan_ref WHERE ex_factory_date_new=\"$dat\"";

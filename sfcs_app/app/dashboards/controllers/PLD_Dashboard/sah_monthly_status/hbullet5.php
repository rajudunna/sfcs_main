...
$sql=mysqli_query($GLOBALS["___mysqli_ston"], "select sum(act_sth),sum(plan_sth) FROM grand_rep where date between \"$start\" and \"$end\" and section=5");
...
$message= "<chart palette='1' lowerLimit='0' upperLimit='$plan_sth' majorTMNumber='0' canvasLeftMargin='120' caption='S-5' subcaption='$per%' showBorder='0' showValue='1' showTickMarks='0' showTickValues='0' targetColor='FF0000' plotFillColor='$col' ticksOnRight='1' >
    <colorRange>
...
//To Write File
	...
	echo "<script type=\"text/javascript\"> setTimeout(\"Redirect()\",0); function Redirect() {  location.href = \"hbullet6.php\"; }</script>";
?>
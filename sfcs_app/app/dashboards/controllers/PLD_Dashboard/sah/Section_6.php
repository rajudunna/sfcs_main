...
$sql2=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT SUM(plan_sth) FROM grand_rep WHERE DATE=\"$dat\" and section=\"6\"");
...
$sql=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT SUM(act_sth) FROM grand_rep WHERE DATE=\"$dat\" and section=\"6\"");
...
$sql1=mysqli_query($GLOBALS["___mysqli_ston"], "select max(bac_lastup) from bai_log where bac_date=\"$dat\" and bac_sec=\"6\"");

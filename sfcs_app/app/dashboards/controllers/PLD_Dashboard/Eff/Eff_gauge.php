...
$sql2=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT SUM(plan_clh),SUM(act_clh),SUM(plan_sth),SUM(act_sth) FROM grand_rep WHERE DATE=\"$date_new\"");
echo "SELECT SUM(plan_clh),SUM(act_clh),SUM(plan_sth),SUM(act_sth) FROM grand_rep WHERE DATE=\"$date_new\"";

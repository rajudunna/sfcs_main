...
//for($i=1;$i<=6;$i++)   
{
$sql15=mysqli_query($GLOBALS["___mysqli_ston"], "select SUM(plan_clh),SUM(act_clh),SUM(plan_sth),SUM(act_sth), section FROM bai_pro.grand_rep WHERE DATE=\"$date_new\" group by section");

                ...
                while($sql_rowx=mysqli_fetch_array($sql_resultx))
                {
                    ...
                    {       
                        ...
                        for($x=0;$x<sizeof($mods);$x++)
                        {
                            ...
                            $sql1="SELECT * FROM $bai_pro3.plan_dash_doc_summ WHERE module=$module AND act_cut_status<>'DONE' AND clubbing<>'0' ".$order_div_ref." GROUP BY clubbing,acutno UNION 
                            ...
                            if($_GET['view']==1)
                            {
                                $sql1="SELECT * FROM $bai_pro3.plan_dash_doc_summ WHERE module=$module AND fabric_staus_new='5' AND clubbing<>'0' ".$order_div_ref." GROUP BY clubbing,acutno UNION 

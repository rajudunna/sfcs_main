...
<link rel=File-List href="<?= getFullURL($_GET['r'],'Book3_files/filelist.xml','R');?>">
<!--[if !mso]>
<style>
...
<table border=0 cellpadding=0 cellspacing=0 width=758 style='border-collapse:
 ...
 <tr height=21 style='height:15.75pt'>
  <td height=21 class=xl1515551 width=24 style='height:15.75pt;width:18pt' colspan=8><?php echo '<div id="bcTarget1" style="width:auto;"></div><script>$("#bcTarget1").barcode("D'.$doc_id.'", "code39",{barWidth:2,barHeight:15,moduleSize:5,fontSize:0});</script>'; ?></td>
...
">
  ...
  src="<?= getFullURL($_GET['r'],'Book3_files/Book1_29570_image003_v2.png','r');?>" alt=LOGO v:shapes="Text_x0020_Box_x0020_13 Picture_x0020_14"></span><![endif]><span
...
">
  ...
  src="<?= getFullURL($_GET['r'],'Book3_files/Book1_15551_image007.gif','R');?>" v:shapes="Text_x0020_Box_x0020_15 AutoShape_x0020_17 Rectangle_x0020_18"></span><![endif]><span
  style='mso-ignore:vglayout2'>
  <table cellpadding=0 cellspacing=0>
   <tr>
    <td height=20 class=xl6315551 width=64 style='height:15.0pt;width:48pt'></td>
...
" o:insetmode="auto">
  ...
  <table cellpadding=0 cellspacing=0>
   ...
   <tr>
    ...
    src="<?= getFullURL($_GET['r'],'Book3_files/Book1_15551_image010.gif','R');?>" v:shapes="AutoShape_x0020_5"></td>
   </tr>
   <tr>
    <td height=120></td>
    <td rowspan=2 align=left valign=top><img width=352 height=124
    src="<?= getFullURL($_GET['r'],'Book3_files/Book1_15551_image011.gif','R');?>" v:shapes="AutoShape_x0020_4"></td>
   </tr>
   <tr>
    <td height=4></td>
   </tr>
...
">
  ...
  <table cellpadding=0 cellspacing=0>
   ...
   <tr>
    ...
    src="<?= getFullURL($_GET['r'],'Book3_files/Book1_15551_image014.gif','R');?>" v:shapes="AutoShape_x0020_8"></td>
   </tr>
   <tr>
    <td height=80></td>
    <td align=left valign=top><img width=595 height=80
    src="<?= getFullURL($_GET['r'],'Book3_files/Book1_15551_image015.gif','R');?>" v:shapes="AutoShape_x0020_6"></td>
   </tr>
  </table>
  </span><![endif]><span style='mso-ignore:vglayout2'>
  <table cellpadding=0 cellspacing=0>

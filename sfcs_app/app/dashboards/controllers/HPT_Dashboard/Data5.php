...
$sql2=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT SUM(plan_pro) FROM pro_plan WHERE DATE=\"$dat\" and sec_no=\"5\"");
while($row2=mysqli_fetch_array($sql2))
{
	$plan=$row2["SUM(plan_pro)"]/16;
}

$sql=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT SUM(act_out) FROM grand_rep WHERE DATE=\"$dat\" and section=\"5\"");

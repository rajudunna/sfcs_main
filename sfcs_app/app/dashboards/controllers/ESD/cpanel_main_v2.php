...
#tooltip .tipHeader {
  height:8px;
  background:url('<?= getFullURL($_GET['r'],'images/tipHeader.gif','R');?>') no-repeat;
  font-size:0px;
}
...
#tooltip .tipFooter {
  height:8px;
  background:url('<?= getFullURL($_GET['r'],'images/tipFooter.gif','R');?>') no-repeat;
}

</style>

<!-- <script type="text/javascript" src="<?= getFullURLLevel($_GET['r'],'visionair/delivery_schedules/jquery-latest.js',3,'R'); ?>"></script> -->
...
$(document).ready(function() {
 ...
 <!-- <script src="<?= getFullURLLevel($_GET['r'],'delivery_schedule/js/jquery/jquery-1.3.2.min.js',3,'R'); ?>" language="javascript" type="text/javascript"></script> -->
<script src="<?= getFullURLLevel($_GET['r'],'jquery-blink.js',0,'R'); ?>" language="javscript" type="text/javascript"></script>
...
<?php
$sql="select max(ims_log_date) as \"lastup\" from ims_log";
      ...
      ?>
            <div class="line_main">
              <div class="line_no">  <!-- module number DIV start -->
                ...
                <?php $sqlwip="SELECT SUM(ims_qty-ims_pro_qty) AS WIP ,ims_doc_no  FROM ims_log WHERE ims_mod_no='$module' ";
        mysqli_query($link, $sqlwip) or exit("Sql Error".mysqli_error($GLOBALS["___mysqli_ston"]));
        ...
        ?></span> -->
                ...
                <?php $sqlred="SELECT SUM(i.ims_qty) AS Input,SUM(i.ims_pro_qty) AS Output,i.ims_doc_no,i.ims_style,i.ims_color,i.ims_schedule,i.rand_track, p.acutno,i.ims_date FROM ims_log i,plandoc_stat_log p WHERE i.ims_mod_no='$module' AND i.ims_doc_no=p.doc_no GROUP BY ims_doc_no";
...
<!-- ADDED NEW -->
             <?php
                  $sql1="SELECT * from plan_dash_doc_summ where module='$module' and act_cut_issue_status<>\"DONE\" order by priority limit 1";
            ...
            while($sql_row1=mysqli_fetch_array($sql_result1)){
              ...
              while($sql_row11=mysqli_fetch_array($sql_result11))
              {
                ...
                $sql11="select trims_status from trims_dashboard where doc_ref=$doc_no";
                $sql_result11=mysqli_query($link,$sql11) or exit("Sql Error".mysqli_error());
                while($sql_row11=mysqli_fetch_array($sql_result11))
                {

...
if(isset($_POST['update']))
{
	...
	$sql="select * from $bai_pro3.bai_orders_db_confirm where order_tid=\"$tran_order_tid\"";
		...
		{	
			...
			$sql="update maker_stat_log set mklength=".$in_mklength[0].", mkeff=$in_mkeff, remarks=\"$remarks\",remark1=\"$remarks_1\",remark2=\"$remarks_2\",remark3=\"$remarks_3\",remark4=\"$remarks_4\", mk_ver=\"$mk_ver\",date=\"$log_date\",lastup=\"$log_time\" where tid=\"$mk_ref\" and recut_lay_plan='yes'";

                    ...
                    if($to_add > 0)
                    {
                        ...
                        foreach($input_job_expo_after as $sj)
                        {
                            ...
                            if($result_excess_job_qry->num_rows > 0)
                            {
                                ...
                                $cps_qry= "select sum(remaining_qty)as remaining_qty  from $bai_pro3.cps_log where doc_no in ($doc_nos) and size_title = '$size_title' and operation_code = $pre_ops_code";

...
$sql = "select * from $bai_pro3.`allocate_stat_log` where cat_ref=".$cat_id." and recut_lay_plan='yes' and serial_no=".$serial_no;
// echo $sql.'<br/>';
$sql_result = mysqli_query($link, $sql) or exit("Sql Error".mysqli_error($GLOBALS["___mysqli_ston"]));
...
if(mysqli_num_rows($sql_result)>0)
{
    while($sql_row=mysqli_fetch_array($sql_result)) 
    {
        ...
        while($sql_row1=mysqli_fetch_array($sql_result1))
        {
            ...
            {
                $sql41 = "select * from $bai_pro3.`allocate_stat_log` where cat_ref=".$sql_row1['tid']." and ratio=".$ratio." and recut_lay_plan='yes' and serial_no=".$serial_no;
                // echo $sql41.'<br/>';
                // die();

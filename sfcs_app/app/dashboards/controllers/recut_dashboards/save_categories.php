...
if(mysqli_num_rows($sql_result)>0)
{
    while($sql_row=mysqli_fetch_array($sql_result)) 
    {
        ...
        while($sql_row1=mysqli_fetch_array($sql_result1))
        {
            ...
            {
                $sql41 = "select * from $bai_pro3.`allocate_stat_log` where cat_ref=".$sql_row1['tid']." and ratio=".$ratio." and recut_lay_plan='yes'";
				// echo $sql41.'<br/>';

...
while($sql_rowx=mysqli_fetch_array($sql_resultx))
{
 ...
 $sql1d="SELECT tbl_id as modx from $bai_pro3.tbl_cutting_table where tbl_id in (".$section_mods.") order by tbl_id*1";
  ...
  // start style wise display by dharani 10-26-2013 
    ...
    $sql1="SELECT * from $bai_pro3.cut_tbl_dash_doc_summ where doc_no in (select doc_ref from $bai_pro3.fabric_priorities where doc_ref in (".implode(",",$doc_no_ref).") order by req_time asc) and act_cut_status<>'DONE' and fabric_status_new !='5' order by field(doc_no,".implode(",",$doc_no_ref).")";

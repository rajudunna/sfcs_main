...
include($_SERVER['DOCUMENT_ROOT'].'/'.getFullURLLevel($_GET['r'],'common/config/functions.php',4,'R'));	
	...
	for($i=0;$i<sizeof($list_db);$i++)
	{
		...
		else
		{
			...
			{
				$sqlr="select tid from $bai_pro3.cat_stat_log where order_tid=\"$order_tid_ref[$ch]\" and category in ('".implode("','",$in_categories)."')";
				///echo $sqlr.";<br>";
    ...
    $url = getFullURL($_GET['r'],'tms_dashboard_input_v22.php','N');

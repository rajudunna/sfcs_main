...
$sec_id=$_GET["sec"];
$sqlx123="SELECT section_display_name FROM $bai_pro3.sections_master WHERE sec_name=$sec_id";
$sql_resultx123=mysqli_query($link, $sqlx123) or exit("Sql Error2".mysqli_error($GLOBALS["___mysqli_ston"]));
while($sql_rowx745=mysqli_fetch_array($sql_resultx123))
{
	$section_name_display=$sql_rowx745['section_display_name'];
}

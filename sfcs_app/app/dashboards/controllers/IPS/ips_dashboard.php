...
while($sql_rowx=mysqli_fetch_array($sql_resultx))
{
	...
	{		
		...
		for($x=0;$x<sizeof($mods);$x++)
		{
			...
			$sql="SELECT input_job_no_random_ref,input_trims_status FROM $table_name WHERE input_module='$module' and date(log_time) >=\"2013-01-09\" GROUP BY input_job_no_random_ref order by input_priority asc limit ".$_GET['priority_limit'];	
			// echo $sql."<br>";

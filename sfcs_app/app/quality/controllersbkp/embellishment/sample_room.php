...
?>
<!---<div id="page_heading"><span style="float: left"><h3>Sample Room - Good Panel/Garments Entry Form</h3></span><span style="float: right"><b>?</b>&nbsp;</span></div>--->
...
//{
	$sql="select distinct order_style_no from $bai_pro3.bai_orders_db_confirm where left(order_style_no,1) in (".$global_style_codes.") order by order_style_no";	
//}

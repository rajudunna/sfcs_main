...
{
	$qty=0;
	$sql11="SELECT * FROM $pps.bai_qms_db_reason_track WHERE plant_code='$plantcode' and qms_reason in(".implode(",",$reasons_list).") and log_date between \"".$sdate."\" and \"".$edate."\" and supplier=\"".$supplier_code[$j12]."\"";
	//echo $sql11."<br>";

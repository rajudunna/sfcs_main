...
$sql1="SELECT distinct supplier as supplier FROM $pps.bai_qms_db_reason_track WHERE plant_code='$plantcode' and qms_reason in (".$reasons_list_ref.") ".$suppliers_list_ref_query." and log_date between \"".$sdate."\" and \"".$edate."\" GROUP BY supplier order by supplier";
//echo $sql1."<br>";  
...
{     
    ...
    {     
        $sql111="SELECT * FROM $pps.bai_qms_db_reason_track WHERE plant_code='$plantcode' and qms_reason in (".$reasons_list[$j121].") and supplier=\"".$supplier_name[$i121]."\" and log_date between \"".$sdate."\" and \"".$edate."\""; 
        //echo $sql111."<br>"; 
        $qty1=0;             

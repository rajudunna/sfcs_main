...
$week_qty=array();
$week_no=array();
$sql1z="SELECT distinct supplier as supplier FROM $pps.bai_qms_db_reason_track WHERE plant_code='$plantcode' and qms_reason in (".$reasons_list_ref.") ".$suppliers_list_ref_query." and log_date between \"".$sdate."\" and \"".$edate."\" GROUP BY supplier";
...
{
	$sql11z="SELECT * FROM $pps.bai_qms_db_reason_track WHERE plant_code='$plantcode' and supplier='".$supplier_namez[$iz1]."' AND qms_reason in (".$reasons_list_ref.") and log_date   between \"".$sdate."\" and \"".$edate."\"";
	// echo $sql11z."<br>";
	$qtyz1=0;	

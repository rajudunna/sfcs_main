...
{
	$qty=0;
	$sql11="SELECT * FROM $pps.bai_qms_db_reason_track WHERE plant_code='$plantcode' and qms_reason in(".$j12.") and log_date between \"".$sdate."\" and \"".$edate."\" ".$suppliers_list_ref_query."";
	//echo $sql11."<br>";

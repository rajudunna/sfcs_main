...
{
	$period_ref="Day";
	$sql1="SELECT distinct log_date as weekno FROM $pps.bai_qms_db_reason_track WHERE plant_code='$plantcode' and log_date between \"".$sdate."\" and \"".$edate."\" GROUP BY log_date order by log_date";
	
}
if($period==2)
{
	$period_ref="Week";
	$sql1="SELECT distinct week(log_date)+1 as weekno FROM $pps.bai_qms_db_reason_track WHERE plant_code='$plantcode' and log_date between \"".$sdate."\" and \"".$edate."\" GROUP BY week(log_date) order by week(log_date)";
}
if($period==3)
{
	$period_ref="Month";
	$sql1="SELECT distinct month(log_date) as weekno FROM $pps.bai_qms_db_reason_track WHERE plant_code='$plantcode' and log_date between \"".$sdate."\" and \"".$edate."\" GROUP BY month(log_date) order by month(log_date)";
}
...
{	
	...
	{	
		...
		if($period==1)
		{
			$sql11="SELECT * FROM $pps.bai_qms_db_reason_track WHERE plant_code='$plantcode' and qms_reason in (".$reason_code[$j12].") and log_date=\"".($week_no[$i12])."\" ".$suppliers_list_ref_query." and log_date between \"".$sdate."\" and \"".$edate."\"";
			if($rejval!=1)
			{
		...
		if($period==2)
		{
			$sql11="SELECT * FROM $pps.bai_qms_db_reason_track WHERE plant_code='$plantcode' and qms_reason in (".$reason_code[$j12].") and week(log_date)=\"".($week_no[$i12]-1)."\" ".$suppliers_list_ref_query." and log_date between \"".$sdate."\" and \"".$edate."\"";
			if($rejval!=1)
			{
		...
		if($period==3)
		{
			$sql11="SELECT * FROM $pps.bai_qms_db_reason_track WHERE plant_code='$plantcode' and qms_reason in (".$reason_code[$j12].") and month(log_date)=\"".($week_no[$i12])."\" ".$suppliers_list_ref_query." and log_date between \"".$sdate."\" and \"".$edate."\"";
			if($rejval!=1)
			{
...
{	
	...
	if($period==1)
	{
		$sql111="SELECT * FROM $pps.bai_qms_db_reason_track WHERE plant_code='$plantcode' and qms_reason in (".implode(",",$reason_code).") and log_date=\"".($week_no[$i121])."\" ".$suppliers_list_ref_query." and log_date between \"".$sdate."\" and \"".$edate."\"";
	...
	if($period==2)
	{
		$sql111="SELECT * FROM $pps.bai_qms_db_reason_track WHERE plant_code='$plantcode' and qms_reason in (".implode(",",$reason_code).") and week(log_date)=\"".($week_no[$i121]-1)."\" ".$suppliers_list_ref_query." and log_date between \"".$sdate."\" and \"".$edate."\"";
		if($rejval!=1)
		{
	...
	if($period==3)
	{
		$sql111="SELECT * FROM $pps.bai_qms_db_reason_track WHERE plant_code='$plantcode' and qms_reason in (".implode(",",$reason_code).") and month(log_date)=\"".($week_no[$i121])."\" ".$suppliers_list_ref_query." and log_date between \"".$sdate."\" and \"".$edate."\"";
		if($rejval!=1)
		{

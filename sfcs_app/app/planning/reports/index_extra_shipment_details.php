...
<link href="<?= '../'.getFullURL($_GET['r'],'style_new.css','R') ?>" rel="stylesheet" type="text/css" />-->
<SCRIPT LANGUAGE="Javascript" SRC="<?= '../'.getFullURLLevel($_GET['r'],'dashboards/fusion_charts/FusionCharts/FusionCharts.js',3,'R') ?>"></SCRIPT>
...
<div class='panel panel-primary'><div class='panel-heading'><h3 class='panel-title'>Extra Shipment Details</h3></div><div class='panel-body'>

<form action="<?= getFullURL($_GET['r'],'index_data_old_new.php','N') ?>" method="post">
<div class="row">
<div class="col-sm-3">

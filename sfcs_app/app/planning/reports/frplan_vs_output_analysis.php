...
-->
		...
		if (isset($_POST['submit'])) {
			...
			$sql = "SELECT DISTINCT(row_name) AS work_station,`group`, GROUP_CONCAT(DISTINCT product_code) AS style FROM $pps.monthly_production_plan LEFT JOIN $pps.monthly_production_plan_upload_log as upload_log ON upload_log.monthly_production_plan_upload_log_id = monthly_production_plan.monthly_production_plan_upload_log_id where  plant_code = '" . $plantcode . "' GROUP BY row_name";

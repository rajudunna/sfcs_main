                ...
                foreach ($style_Po_number_array as $style_code => $po_number) {
                    ...
                    if ($Cut_Qty == 1 || $All == 1) {
                        ...
                        for ($i = 0; $i < sizeof($week_code); $i++) {
                            ...
                            $cutQty=0;
                            $lay_jm_docket_lines="SELECT `mp_sub_order`.`master_po_number`,`jm_actual_docket`.`po_number`,`jm_actual_docket`.`jm_docket_id`,`jm_actual_docket`.`plies` FROM $pps.`jm_actual_docket` JOIN $pps.`mp_sub_order` ON 

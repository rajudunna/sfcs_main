<?php
    ...
    if($update_revers_qry_result) {
        ...
        {      
            $rev_ips_chk_qry = "select * from $bai_pro3.plan_dashboard_input_backup where input_job_no_random_ref in (".implode(",",$remove_ref_nums).") and short_shipment_status = '1'";
            ...
            $rev_ims_chk_qry = "select * from $bai_pro3.plan_dashboard_input_backup where input_job_no_random_ref in (".implode(",",$remove_ref_nums).") and short_shipment_status = '1'";
            ...
            if($wip_chck_qry_res > 0){
                $wip_dash_table_update="UPDATE $brandix_bts.`bundle_creation_data` SET bundle_qty_status='0' WHERE input_job_no_random_ref in (".implode(",",$remove_ref_nums).") and bundle_qty_status='3'";

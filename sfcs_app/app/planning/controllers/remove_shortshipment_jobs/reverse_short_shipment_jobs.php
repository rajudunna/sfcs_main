    ...
    if($update_revers_qry_result) {
        ...
        {      
            ...
            if(sizeof($ips_tms_jobs)>0){
                $sql_check="select * from $bai_pro3.plan_dashboard_input where input_job_no_random_ref in (".implode(",",$ips_tms_jobs).")";
            ...
            if(sizeof($ims_jobs)>0){
                $sql_check1="select * from $bai_pro3.ims_log where input_job_rand_no_ref in (".implode(",",$ims_jobs).")";

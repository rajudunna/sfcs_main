            ...
            if($insert_qry_result) {
                ...
                if(sizeof($remove_ref_nums)>0)
                {
                    ...
                    if(sizeof($ips_tms_jobs)>0){
                        $sql_check="select input_job_no_random_ref from $bai_pro3.plan_dashboard_input_backup where input_job_no_random_ref in (".implode(",",$ips_tms_jobs).")";
                    ...
                    if(sizeof($ims_jobs)>0){
                        $sql_check2="select input_job_rand_no_ref from $bai_pro3.ims_log_backup where input_job_rand_no_ref in (".implode(",",$ims_jobs).")";

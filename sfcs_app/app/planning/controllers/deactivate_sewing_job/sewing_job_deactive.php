                ...
                //   $dockets=implode(",",$docket_numbers);
                  ...
                  $jm_jg_header_id=$key;
                   ...
                   while($des_row=mysqli_fetch_array($query_result))
                   {
                    ...
                    $job_deacive = "SELECT remove_type FROM $tms.`job_deactive_log` where input_job_no_random = '$key' and input_job_no='$input_job_no' and plant_code='$plant_code' and remove_type = '3'";

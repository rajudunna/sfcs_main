...
<script type="text/javascript" src="<?= getFullURLLevel($_GET['r'],'common/js/sweetalert.min.js',3,'R'); ?>"></script>
<script>	
	function pop_test(e)
	{
		var count = 0;
...
<link rel="stylesheet" href="<?= getFullURLLevel($_GET['r'],'common/css/TableFilter_EN/filtergrid.css',3,'R'); ?>">

		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<table id="example" class="table table-bordered">
					<thead>
						<tr>
							<th style="display: none;"><center>Schedule No</center></th>
					...
					<tbody>
						<?php
							$get_data = "SELECT * FROM $bai_pro3.`jobs_movement_track` ORDER BY log_time";
							...
							while($sql_rowr1=mysqli_fetch_array($resultr1))
							{
								echo"
									<tr>
										<td style='display: none;'><center>".$sql_rowr1["id"]."</center></td>
										<td><center>".$sql_rowr1["schedule_no"]."</center></td>
										<td><center>".$sql_rowr1["input_job_no"]."</center></td>

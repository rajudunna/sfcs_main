								...
								<ul id="allItems">
									...
									<?php
										...
										for($i=0;$i<sizeof($code_db)-1;$i++)
										{
											...
											echo "<li id=\"".$code_db_new[0]."\" style=\" background-color:$check; border-color:#b8daff; color:#f6f6f6;\" title=\"$title\" class=\"normalTip\"><strong><font color='$font_color'>".$code_db_new[1]."</font></strong></li>";
										}
									?>

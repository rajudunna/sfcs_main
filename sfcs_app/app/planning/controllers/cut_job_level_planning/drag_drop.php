		...
		<script type="text/javascript">
			...
			************************************************************************************************************/
			...
			function initDrag(e)	// Mouse button is pressed down on a LI
			{
				...
				alert(dragContentObj.style.left );
				alert(dragContentObj.style.top);
				...
				<div class="panel-body">
					...
					<div id="dhtmlgoodies_dragDropContainer">
						...
						<div id="dhtmlgoodies_listOfItems">
							...
							<form action="<?= getFullURLLevel($_GET['r'],'drag_drop_process.php',0,'N'); ?>" method="post" name="myForm" onclick="saveDragDropNodes()" style="position: fixed;margin-left: 47px;">

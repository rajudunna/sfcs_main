...
?>
<!-- <div id="page_heading"><span style="float: left"><h3>Production Planning Panel</h3></span><span style="float: right"><b>?</b>&nbsp;</span></div> -->
...
if(isset($_POST['submit']))
{
	...
	echo "<script type=\"text/javascript\"> setTimeout(\"Redirect()\",0); function Redirect() {  location.href = \"drag_drop.php\"; }</script>";
}
?>  

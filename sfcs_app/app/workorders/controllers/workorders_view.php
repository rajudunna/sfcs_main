<div class="box box-info">
	...
	<div class="box-body">
		...
		<div class="row">
			<div class="col-md-2">
				<span><b>Production Status</b></span>
			</div>
			<div class="col-md-10">
				<ol class="breadcrumb">
				  <li><a href="#">LayPlan Preparation</a></li>
				  <li><a href="#">Next Activity</a></li>
				  <li class="active">Then Activity</li>
				</ol>
			</div>
		</div>

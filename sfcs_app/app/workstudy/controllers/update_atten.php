...
$username=$_SESSION['userName'];
    ...
    for ($i = 0; $i < sizeof($modules); $i++)
    {
        ...
        $sqls = "SELECT * FROM $pts.pro_atten WHERE plant_code='$plantcode' and date='$today' AND module='$mod'";
        ...
        $sql = "UPDATE $pts.pro_atten SET avail_A='".$ava."',jumpers='".$jump."',absent_A='".$abf."',absent_B='".$abnf."',updated_user='$username',updated_at='".date('Y-m-d')."' WHERE plant_code='$plantcode' and date='".$today."' AND module='".$mod."'";

...
function thirdbox()
{
	window.location.href ="index.php?r=<?php echo $_GET['r'] ?>"+"&style="+encodeURIComponent(window.btoa(document.test.style.value))+"&schedule="+document.test.schedule.value+"&color="+encodeURIComponent(window.btoa(document.test.color.value))
}
</script>

		...
		<?php
			if(isset($_GET['select']))
			{
				if($_GET['select']==1)
				{
					...
					$emp_id=$_GET['emp_id'];
					$sql_schedule="update pms.tbl_fg_crt_handover_team_list set selected_user=USER(), lastup='".date("Y-m-d H:i:s")."' where team_id=$team_id and emp_id='$emp_id'";
					// echo $sql_schedule;
			...
			echo "<div class='col-md-12 table-responsive' style='max-height:900px;overflow-y:scroll;'>
					...
					<table class='table table-bordered'>
						...
						$sql_schedule="select * from pms.tbl_fg_crt_handover_team_list where emp_status=0 order by 1*emp_id";

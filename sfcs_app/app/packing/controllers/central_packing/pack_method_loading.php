...
<table class='table table-bordered'>
 ...
 <tr class=xl7219400 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  ?>
			...
			echo "<div class='col-md-4'>Style: ".$style_id."</div>";
			echo "<div class='col-md-4'>Buyer Division: ".$division."</div>";
			echo "<div class='col-md-4'>Schedule No: ".$schedule_id."</div>";
			
			echo "</div>";
			echo "<div class='col-md-12'>";
			echo "<div class='col-md-4'>MPO: ".$mpo."</div>";
			echo "<div class='col-md-4'>CPO: ".$cpo."</div>";
			echo "<div class='col-md-4'>Customer Order :".$cust_ord."</div>";

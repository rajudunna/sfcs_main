...
$old = "select * from $bai_pro3.bai_orders_db_confirm where $order_joins_not_in and order_style_no=\"$style\" and order_del_no=$schedule";
...
{
	$sql="select * from $bai_pro3.bai_orders_db where $order_joins_not_in and order_style_no=\"$style\" and order_del_no=$schedule";
}
...
<table border=0 cellpadding=0 cellspacing=0 width=1210 class=xl6619400
 ...
 <tr class=xl7219400 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl7419400 style='height:15.75pt'>Ship Qty:</td>
  ...
  <td class=xl7219400></td>
 			...
 			<tr class=xl7219400 height=21 style='mso-height-source:userset;height:15.75pt'>
				<td height=21 class=xl7419400 style='height:15.75pt'>Actual Qty:</td>

...
$assortcolor2=explode("$",$assortcolor_title);
...
{
	// echo $packpcs[$i]."-".$assortcolor[$i]."<br/>";
}
...
// echo "sum of assort pieces:".$sum_of_assort_pcs."<br/>";
...
if($sql_rows > 0)
{
	// header("Location:error_packing_list.php");
...
for($mm=0;$mm<sizeof($packpcs);$mm++)
{
	...
	while($sql_row_group=mysqli_fetch_array($sql_result_group))
	{
		...
		while($sql_row2=mysqli_fetch_array($sql_result2))
		{
			...
			$sql_result22=mysqli_query($link, $sql22) or exit("Sql Error9.1".mysqli_error($GLOBALS["___mysqli_ston"]));
		...
		$sql1="SELECT * FROM bai_pro3.ratio_input_update where order_tid=\"$order_tid1\" ";
		echo $sql1;
		...
		{
			$ratio_size=$sql_row1['sfcs_size'];
			$ratio_qty=$sql_row1['ratio_qty'];	
			$rand_track_no=$sql_row1['rand_track_no'];
			echo "Size-".$ratio_size."<br>";
			if($ratio_size=='s01')
			{
				$carton_s01=$ratio_qty;
				//$set_type_s01=$set_type;
			}
			if($ratio_size=='s02')
			{
				$carton_s02=$ratio_qty;
				//$set_type_s02=$set_type;
			}
			if($ratio_size=='s03')
			{
				$carton_s03=$ratio_qty;
				//$set_type_s03=$set_type;
			}
			if($ratio_size=='s04')
			{
				$carton_s04=$ratio_qty;
				//$set_type_s04=$set_type;
			}
			if($ratio_size=='s05')
			{
				$carton_s05=$ratio_qty;
				//$set_type_s05=$set_type;
			}
			if($ratio_size=='s06')
			{
				$carton_s06=$ratio_qty;
				//$set_type_s06=$set_type;
			}
			if($ratio_size=='s07')
			{
				$carton_s07=$ratio_qty;
				//$set_type_s07=$set_type;
			}
			if($ratio_size=='s08')
			{
				$carton_s08=$ratio_qty;
				//$set_type_s08=$set_type;
			}
			if($ratio_size=='s09')
			{
				$carton_s09=$ratio_qty;
				//$set_type_s09=$set_type;
			}
			if($ratio_size=='s10')
			{
				$carton_s10=$ratio_qty;
				//$set_type_s10=$set_type;
			}
			if($ratio_size=='s11')
			{
				$carton_s11=$ratio_qty;
				//$set_type_s11=$set_type;
			}
			if($ratio_size=='s12')
			{
				$carton_s12=$ratio_qty;
				//$set_type_s12=$set_type;
			}
			if($ratio_size=='s13')
			{
				$carton_s13=$ratio_qty;
				//$set_type_s13=$set_type;
			}
			if($ratio_size=='s14')
			{
				$carton_s14=$ratio_qty;
				//$set_type_s14=$set_type;
			}
			if($ratio_size=='s15')
			{
				$carton_s15=$ratio_qty;
				//$set_type_s15=$set_type;
			}
			if($ratio_size=='s16')
			{
				$carton_s16=$ratio_qty;
				//$set_type_s16=$set_type;
			}
			if($ratio_size=='s17')
			{
				$carton_s17=$ratio_qty;
				//$set_type_s17=$set_type;
			}
			if($ratio_size=='s18')
			{
				$carton_s18=$ratio_qty;
				//$set_type_s18=$set_type;
			}
			if($ratio_size=='s19')
			{
				$carton_s19=$ratio_qty;
				//$set_type_s19=$set_type;
			}
			if($ratio_size=='s20')
			{
				$carton_s20=$ratio_qty;
				//$set_type_s20=$set_type;
			}
			if($ratio_size=='s21')
			{
				$carton_s21=$ratio_qty;
				//$set_type_s21=$set_type;
			}
			if($ratio_size=='s22')
			{
				$carton_s22=$ratio_qty;
				//$set_type_s22=$set_type;
			}
			if($ratio_size=='s23')
			{
				$carton_s23=$ratio_qty;
				//$set_type_s23=$set_type;
			}
			if($ratio_size=='s24')
			{
				$carton_s24=$ratio_qty;
				//$set_type_s24=$set_type;
			}
			if($ratio_size=='s25')
			{
				$carton_s25=$ratio_qty;
				//$set_type_s25=$set_type;
			}
			if($ratio_size=='s26')
			{
				$carton_s26=$ratio_qty;
				//$set_type_s26=$set_type;
			}
			if($ratio_size=='s27')
			{
				$carton_s27=$ratio_qty;
				//$set_type_s27=$set_type;
			}
			if($ratio_size=='s28')
			{
				$carton_s28=$ratio_qty;
				//$set_type_s28=$set_type;
			}
			if($ratio_size=='s29')
			{
				$carton_s29=$ratio_qty;
				//$set_type_s29=$set_type;
			}
			if($ratio_size=='s30')
			{
				$carton_s30=$ratio_qty;
				//$set_type_s30=$set_type;
			}
			if($ratio_size=='s31')
			{
				$carton_s31=$ratio_qty;
				//$set_type_s31=$set_type;
			}
			if($ratio_size=='s32')
			{
				$carton_s32=$ratio_qty;
				//$set_type_s32=$set_type;
			}
			if($ratio_size=='s33')
			{
				$carton_s33=$ratio_qty;
				//$set_type_s33=$set_type;
			}
			if($ratio_size=='s34')
			{
				$carton_s34=$ratio_qty;
				//$set_type_s34=$set_type;
			}
			if($ratio_size=='s35')
			{
				$carton_s35=$ratio_qty;
				//$set_type_s35=$set_type;
			}
			if($ratio_size=='s36')
			{
				$carton_s36=$ratio_qty;
				//$set_type_s36=$set_type;
			}
			if($ratio_size=='s37')
			{
				$carton_s37=$ratio_qty;
				//$set_type_s37=$set_type;
			}
			if($ratio_size=='s38')
			{
				$carton_s38=$ratio_qty;
				//$set_type_s38=$set_type;
			}
			if($ratio_size=='s39')
			{
				$carton_s39=$ratio_qty;
				//$set_type_s39=$set_type;
			}
			if($ratio_size=='s40')
			{
				$carton_s40=$ratio_qty;
				//$set_type_s40=$set_type;
			}
			if($ratio_size=='s41')
			{
				$carton_s41=$ratio_qty;
				//$set_type_s41=$set_type;
			}
			if($ratio_size=='s42')
			{
				$carton_s42=$ratio_qty;
				//$set_type_s42=$set_type;
			}
			if($ratio_size=='s43')
			{
				$carton_s43=$ratio_qty;
				//$set_type_s43=$set_type;
			}
			if($ratio_size=='s44')
			{
				$carton_s44=$ratio_qty;
				//$set_type_s44=$set_type;
			}
			if($ratio_size=='s45')
			{
				$carton_s45=$ratio_qty;
				//$set_type_s45=$set_type;
			}
			if($ratio_size=='s46')
			{
				$carton_s46=$ratio_qty;
				//$set_type_s46=$set_type;
			}
			if($ratio_size=='s47')
			{
				$carton_s47=$ratio_qty;
				//$set_type_s47=$set_type;
			}
			if($ratio_size=='s48')
			{
				$carton_s48=$ratio_qty;
				//$set_type_s48=$set_type;
			}
			if($ratio_size=='s49')
			{
				$carton_s49=$ratio_qty;
				//$set_type_s49=$set_type;
			}
			if($ratio_size=='s50')
			{
				$carton_s50=$ratio_qty;
				//$set_type_s50=$set_type;
			}
		}
		...
		$sql_result=mysqli_query($link, $sql) or exit("Sql Error15".mysqli_error($GLOBALS["___mysqli_ston"]));
		$sql_num_=mysqli_num_rows($sql_result);
		while($sql_row=mysqli_fetch_array($sql_result))
		{
			$a_xs=$sql_row['p_xs'];
			...
			if($cutno==$first_cut)
			{
				...
				mysqli_query($link, $sql) or exit("Sql Error19".mysqli_error($GLOBALS["___mysqli_ston"]));
				}
				}
				}
				$ex_xs=0;
				...
				if($temp>=$carton_l)
				{
				$sql="insert $bai_pro3.into $bai_pro3.pac_stat_log (doc_no,remarks,doc_no_ref,size_code,carton_no,carton_mode,carton_act_qty) values (\"$docketno\",\"$label_title\",\"$docketno\",\"l\",$l,\"F\",".($carton_l).")";
				mysqli_query($link, $sql) or exit("Sql Error".mysqli_error($GLOBALS["___mysqli_ston"]));
				}
				else
				{
				$sql="insert $bai_pro3.into $bai_pro3.pac_stat_log (doc_no,remarks,doc_no_ref,size_code,carton_no,carton_mode,carton_act_qty) values (\"$docketno\",\"$label_title\",\"$docketno\",\"l\",$l,\"P\",".($temp).")";
				mysqli_query($link, $sql) or exit("Sql Error".mysqli_error($GLOBALS["___mysqli_ston"]));
				}
				...
				{
				$sql="insert $bai_pro3.into $bai_pro3.pac_stat_log (doc_no,remarks,doc_no_ref,size_code,carton_no,carton_mode,carton_act_qty) values (\"$docketno\",\"$label_title\",\"$docketno\",\"l\",$i,\"F\",$carton_l)";
				mysqli_query($link, $sql) or exit("Sql Error".mysqli_error($GLOBALS["___mysqli_ston"]));
				}
				}
				}
	...
	// mysqli_query($link, $sql) or exit("Sql Error".mysqli_error($GLOBALS["___mysqli_ston"]));
	// $sql_result=mysqli_query($link, $sql) or exit("Sql Error103".mysqli_error($GLOBALS["___mysqli_ston"]));
	// $sql_num_=mysqli_num_rows($sql_result);
	// while($sql_row=mysqli_fetch_array($sql_result))
	// {
	...
	//echo $sql."<br/>";
	// mysqli_query($link, $sql) or exit("Sql Error".mysqli_error($GLOBALS["___mysqli_ston"]));
	$sql_result=mysqli_query($link, $sql) or exit("Sql Error107".mysqli_error($GLOBALS["___mysqli_ston"]));
	while($sql_row=mysqli_fetch_array($sql_result))
	{
	...
	//echo $sql."<br/>";
	// mysqli_query($link, $sql) or exit("Sql Error".mysqli_error($GLOBALS["___mysqli_ston"]));
	$sql_result=mysqli_query($link, $sql) or exit("Sql Error108".mysqli_error($GLOBALS["___mysqli_ston"]));
	while($sql_row=mysqli_fetch_array($sql_result))
	{
	$completed_tid[]=$sql_row['tid'];
	$temp_tid[]=$sql_row['tid'];
	...
	$sql1="update $bai_pro3.pac_stat_log set carton_act_qty=$temp_pack_qty 
	where tid=".$sql_row['tid'];
	// // echo $sql1."<br/>";
	mysqli_query($link, $sql1) or exit("Sql Error109".mysqli_error($GLOBALS["___mysqli_ston"]));
	...
	//	echo $sql."<br/>";
	// mysqli_query($link, $sql) or exit("Sql Error".mysqli_error($GLOBALS["___mysqli_ston"]));
	$sql_result=mysqli_query($link, $sql) or exit("Sql Error34".mysqli_error($GLOBALS["___mysqli_ston"]));
	while($sql_row=mysqli_fetch_array($sql_result))
	{
	$completed_tid[]=$sql_row['tid'];
	$temp_tid[]=$sql_row['tid'];
	...
	// // echo $sql."<br/>";
	mysqli_query($link, $sql) or exit("Sql Error35".mysqli_error($GLOBALS["___mysqli_ston"]));

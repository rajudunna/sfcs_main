...
$sql_result=mysqli_query($link, $sql) or exit("Sql Erro3".$sql);
...
while($sql_row=mysqli_fetch_array($sql_result))
{
	...
	//	  echo "order_sum=".array_sum($order_qtys)."<br/>";
    //    echo "carton_qty=".$sql_row['carton_act_qty'];
	}
}
...
<table border=0 cellpadding=0 cellspacing=0 width=1210 class=xl6619400
 ...
 <tr class=xl6419400 height=22 style='mso-height-source:userset;height:16.5pt'>
  ...
  width:759pt'>FG Packing List</td>
 ...
 <tr class=xl6553519400 height=20 style='height:15.0pt'>
  ...
  <td class=xl7819400 style='border-left:none'>Rec.</td>
				 ...
				 else
				 {
				  ...
				  for($m=$j;$m<$j+4;$m++)
				  {
					  ...
					  if($node_detail[2]>0)
					  {
						  ...
						  <td class=xl8419400 style='border-left:none' colspan=2>".$node_detail[3]."</td>";
					  }
					  else
					  {

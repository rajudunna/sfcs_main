		...
		<div class='panel-body'>		
			<form name="input" method="post" action="<?php echo '?r='.$_GET['r']; ?>">
				...
				$username = $_SESSION['userName'];
					...
					{
						$sel_value=$_POST['sel'];
						$get_tids = "SELECT ship_tid FROM $pps.ship_stat_log where plant_code='$plant_code' AND ship_up_date in ("."'" . implode ( "', '", $sel_value ) . "'".")";
						...
						if(sizeof($sel)>0)
						{
							...
							echo "<div class='col-sm-4 left'>Party<b>:</b></div>
								...
								$sql="select * from $pps.party_db where plant_code='$plant_code' order by order_no";

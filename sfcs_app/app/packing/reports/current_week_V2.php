...
<div class="panel-heading">Current Week Delivery Status Report</h3></div>
...
echo "<input type=\"submit\" name=\"submitx\" value=\"Show\" class='btn btn-primary' style='margin-top:22px;' onclick=\"javascript:button_disable();\">";
?>
...
if(isset($_POST['submitx']) or isset($_GET['division']))
{
	...
	// echo $sql;
	$result=mysqli_query($link,$sql) or die("Error2 = ".mysqli_error());
	...
	else
	{
		while($row=mysqli_fetch_array($result))
		{
			...
			// echo $sql1."<br>";
			$result1=mysqli_query($link,$sql1) or die("Error3 = ".mysqli_error());
			...
			$result_co=mysqli_query($link,$sql_co) or die("Error4 =".mysqli_error());

...
<body>';
	...
	$html.= '<div><table>';
	$html.= '<tr><td align=left>Style:</td><td class="new_td" width="50%">'.$node_detail[0].'</td><td align=right>Size:</td><td class="new_td">'.$node_detail[3].'</td></tr>';
	$html.= '<tr><td align=left>Sch.:</td><td class="new_td">'.$node_detail[1].'</td><td align=right>Qty:</td><td class="new_td">'.$node_detail[4].'</td></tr>';
	$html.= '<tr><td align=left>Color.:</td><td class="new_td">'.$node_detail[2].'</td><td align=right>Sign:</td><td class="new_td2"></td></tr>';
	$html.= '<tr><td align=left>Date.:</td><td class="new_td2"></td><td align=right>Mod.:</td><td class="new_td2"></td></tr>';

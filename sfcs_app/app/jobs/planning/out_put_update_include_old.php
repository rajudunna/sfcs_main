...
$sql="select order_tid as ssc_code_new, order_del_no as schedule_no, order_style_no as style, order_col_des as color from $bai_pro3.bai_orders_db where order_del_no in (".implode(",",$schedules_to_update).")";
	...
	$sql_result=mysqli_query($link, $sql) or exit("Sql Errorx4".mysqli_error($GLOBALS["___mysqli_ston"]));
	while($sql_row=mysqli_fetch_array($sql_result))
	{
		...
		$sql_result1=mysqli_query($link, $sql1) or exit("Sql Error 8".mysqli_error($GLOBALS["___mysqli_ston"]));
		...
		//echo $sql1."<br/>";
		$sql_resultx1=mysqli_query($link, $sqlx1) or exit("Sql Errorx12".mysqli_error($GLOBALS["___mysqli_ston"]));
		...
		//echo $sql1."<br/>";
		$sql_resultx1=mysqli_query($link, $sqlx1) or exit("Sql Errorx13".mysqli_error($GLOBALS["___mysqli_ston"]));
		$counter_check+=mysqli_num_rows($sql_resultx1);
		while($sql_rowx1=mysqli_fetch_array($sql_resultx1))
		{
			$input_total+=$sql_rowx1['ims_qty'];
		...
		$sql_resultx1=mysqli_query($link, $sqlx1) or exit("Sql Errorx14".mysqli_error($GLOBALS["___mysqli_ston"]));
		while($sql_rowx1=mysqli_fetch_array($sql_resultx1))
		{
		...
		*/
		...
		$sql_resultx1=mysqli_query($link, $sqlx1) or exit("Sql Errorx18".mysqli_error($GLOBALS["___mysqli_ston"]));
		while($sql_rowx1=mysqli_fetch_array($sql_resultx1))
		{

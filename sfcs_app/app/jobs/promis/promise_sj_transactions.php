...
if($conn)
{
	...
	reason,CASE WHEN CAST(date_time AS TIME) BETWEEN '00:00:00' AND '09:44:59' THEN 1 WHEN CAST(date_time AS TIME) BETWEEN '09:45:00' AND '10:44:59' THEN 2 WHEN CAST(date_time AS TIME) BETWEEN '10:45:00' AND '11:44:59' THEN 3 WHEN CAST(date_time AS TIME) BETWEEN '11:45:00' AND '12:59:59' THEN 4 WHEN CAST(date_time AS TIME) BETWEEN '13:00:00' AND '14:14:59' THEN 5 WHEN CAST(date_time AS TIME) BETWEEN '14:15:00' AND '15:14:59' THEN 6 WHEN CAST(date_time AS TIME) BETWEEN '15:15:00' AND '16:14:59' THEN 7 WHEN CAST(date_time AS TIME) BETWEEN '16:15:00' AND '16:59:59' THEN 8 WHEN CAST(date_time AS TIME) BETWEEN '17:00:00' AND '18:29:59' THEN 9 WHEN CAST(date_time AS TIME) BETWEEN '18:30:00' AND '11:59:59' THEN 10 END AS slot_id from $bai_pro3.m3_transactions where api_type='opn' and promis_status=0 and date_time between '$date 00:00:00' and '$date 23:59:59'";

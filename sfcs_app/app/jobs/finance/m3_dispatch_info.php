...
fputcsv($file,$title_list);
			...
			$sqlx="select *,SUBSTRING_INDEX(prepared_by,'@',1) as prepared from $pps.disp_db where date(exit_date)='$date' and plant_code='$plant_code'";
			...
			while($sql_rowx=mysqli_fetch_array($sql_resultx))
			{
				...
				while($sql_rowx1=mysqli_fetch_array($sql_resultx1))
				{
					...
					$sqlx11="select remarks from $pps.packing_summary where order_del_no='$ship_schedule' and plant_code='$plant_code' limit 1";
					$sql_resultx11=mysqli_query($link, $sqlx11) or exit("Sql Error".mysqli_error($GLOBALS["___mysqli_ston"]));
					while($sql_rowx11=mysqli_fetch_array($sql_resultx11))
					{

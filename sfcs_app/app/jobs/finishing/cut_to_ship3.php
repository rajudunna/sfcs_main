...
<input type="button" class="btn btn-xs btn-success" value="Export to Excel" onclick="getCSVData()">
	...
	<th class=\"total\" style='background-color:#29759C;'>Cutting <br/>Missing</th>
		...
		//$sql="select style,schedule_no,color,ssc_code_new,priority,buyer_division,ex_factory_date_new,sections from bai_pro4.bai_cut_to_ship_ref where schedule_no in (77724)";	

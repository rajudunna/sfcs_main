...
FROM `m3_bulk_ops_rep_db`.`m3_sfcs_tran_log` WHERE (sfcs_date between '$sdate' and '$edate') and  sfcs_style IN (
'SCU40007',
'SCU30197',
'SCN30197') and m3_op_des='SOT' AND sfcs_reason='' ORDER BY sfcs_date";
//echo $sqlx;

			...
			else
			{
				if($is_m3 == 'Yes' || $is_m3 == 'yes' || $is_m3 == 'YES' )
				{
					...
					else
					{
						...
						$tbl_style_ops_master_insert="insert ignore $brandix_bts.tbl_style_ops_master(parent_id,operation_name,operation_order,style,color, operation_code,default_operration,ops_sequence,previous_operation,barcode,ops_dependency,smv,m3_smv,main_operationnumber) values('".$select_default_operations_row['id']."','".$select_default_operations_row['operation_name']."','".$select_default_operations_row['operation_order']."','".$style."','".$color."','".$select_default_operations_row['operation_code']."','".$select_default_operations_row['default_operration']."','".$select_default_operations_row['ops_sequence']."','".$select_default_operations_row['previous_operation']."','".$select_default_operations_row['barcode']."','".$select_default_operations_row['ops_dependency']."','".$m3_smv."','".$m3_smv."','".$main_ops_code."')";
				...
				{
					$m3_smv = '0.00';
					$tbl_style_ops_master_insert="insert ignore $brandix_bts.tbl_style_ops_master(parent_id,operation_name,operation_order,style,color, operation_code,default_operration,ops_sequence,previous_operation,barcode,ops_dependency,smv,m3_smv) values('".$select_default_operations_row['id']."','".$select_default_operations_row['operation_name']."','".$select_default_operations_row['operation_order']."','".$style."','".$color."','".$select_default_operations_row['operation_code']."','".$select_default_operations_row['default_operration']."','".$select_default_operations_row['ops_sequence']."','".$select_default_operations_row['previous_operation']."','".$select_default_operations_row['barcode']."','".$select_default_operations_row['ops_dependency']."','".$m3_smv."','".$m3_smv."')";
					echo "1=".$tbl_style_ops_master_insert."<br>";
					mysqli_query($link, $tbl_style_ops_master_insert) or exit("Sql Error tbl_style_ops_master_insert".mysqli_error($GLOBALS["___mysqli_ston"]));

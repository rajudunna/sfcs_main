...
while($row = mysqli_fetch_array($result))
{
        ...
        if($sql_num_check1>0)
        {
                ...
                $sql2="insert into [$m3_databasename].[dbo].[tbl_Update_M3_MRN_Link](CONO,Color,EmployeeNo,Inputdate,Line,Status) values('".$co_no."','".$order_col_des."','".$employee_no."','".$date."','".$line."',NULL)";
                echo $sql2."<br>";

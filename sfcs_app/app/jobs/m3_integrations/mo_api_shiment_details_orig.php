...
$qry_get_soap_data = "SELECT *,group_concat(id) as ids FROM $bai_pro3.`mo_details` WHERE shipment_master_status=0 group by style,SCHEDULE,color,size";

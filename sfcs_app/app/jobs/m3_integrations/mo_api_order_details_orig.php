...
while($result_data = mysqli_fetch_array($res_get_soap_data)){
    ...
    print("response1 API Call Start: ".$moac1." milliseconds. Parameters: ".$api_url."; ")."\n";
            
    $response1 = getCurlAuthRequestLocal1($api_url,$basic_auth);
    
    $moac2=microtime(true);
    print("response1 API call End : ".$moac2."milliseconds")."\n";
    print("response1 API call Duration : ".($moac2-$moac1)."milliseconds")."\n";
    ...
    if($response1['status'] && isset($response1['response'][0]['PRNO'])){
        foreach($response1['response'] as $resp_resp){
            ...
            print("response_wastage API call End : ".$moac4."milliseconds")."\n";
            print("response_wastage API call Duration : ".($moac4-$moac3)."milliseconds")."\n";
            ...
            print("response_size_data API call End : ".$moac6."milliseconds")."\n";
            print("response_size_data API call Duration : ".($moac6-$moac5)."milliseconds")."\n";
                ...
                print("response_color_data API call End : ".$moac8."milliseconds")."\n";
                print("response_color_data API call Duration : ".($moac8-$moac7)."milliseconds")."\n";
                    ...
                    print("size_description API call End : ".$moac10."milliseconds")."\n";
                    ...
                    print("z_feature_description API call End : ".$moac12."milliseconds")."\n";
                    print("z_feature_description API call Duration : ".($moac12-$moac11)."milliseconds")."\n";
                   //=========== save data ================
                ...
                item_code,item_description,color,color_description,size,z_code,per_piece_consumption,wastage,uom,material_sequence,product_no,operation_code) VALUES (now(),'".$mo_no."','".$global_facility_code."','".urldecode($item_code)."',\"".$item_description."\",'".$color_res."',\"".$color_description."\",'".$size_description."','".$z_feature_description."','".$order_yy."','".$wastage."','".$uom."','".$sequence_no."','".urldecode($prno)."','".$response['response']['OPNO']."')";
                    ...
                    if(in_array(trim($response['response']['OPNO']),$res_chk_op)){
                        ...
                        print("item_description1 API call End : ".$moac14."milliseconds")."\n";
                        print("item_description1 API call Duration : ".($moac14-$moac13)."milliseconds")."\n";
                        ...
                        print("response_customer_style API call End : ".$moac16."milliseconds")."\n";
                        print("response_customer_style API call Duration : ".($moac16-$moac15)."milliseconds")."\n";

...
>>>>>>> af0cb5c6944cad0e4334b469fc522f263f9118ef
    ...
    <div class="col-md-12">
        ...
        <div class="box-body">
            ...
            <div class="btn-group pull-right" role="group" aria-label="..." myattribute="production_body">
                ...
                <div class="btn-group" role="group">
                <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Cutting<span class="caret"></span></button><ul class="dropdown-menu"><li><a href="?r=L3NmY3NfYXBwL2FwcC9kYXNoYm9hcmRzL2NvbnRyb2xsZXJzL2Nwcy9mYWJfcHJpb3JpdHlfZGFzaGJvYXJkLnBocA==" myattribute="production_body" id="cut">Cut</a></li><li><a href="?r=<?= base64_encode('/sfcs_app/app/dashboards/controllers/RTS/fab_pps_recut_dashboard_v4.php');?>" myattribute="production_body" id="recut">Re-Cut</a></li></ul></div>
                <div class="btn-group" role="group"><button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Material<span class="caret"></span></button><ul class="dropdown-menu"><li><a href="?r=L3NmY3NfYXBwL2FwcC9kYXNoYm9hcmRzL2NvbnRyb2xsZXJzL3Rtcy90bXNfZGFzaGJvYXJkX2lucHV0LnBocA==" myattribute="production_body" id="trims">Trims</a></li><li><a href="?r=L3NmY3NfYXBwL2FwcC9kYXNoYm9hcmRzL2NvbnRyb2xsZXJzL3Jtcy9mYWJfcHBzX2Rhc2hib2FyZF92Mi5waHA=" myattribute="production_body" id="fabric">Fabric</a></li></ul></div>

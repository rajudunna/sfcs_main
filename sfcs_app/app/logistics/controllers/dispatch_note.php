...
$sql="select * from disp_db left join party_db on disp_db.party=party_db.pid where disp_db.disp_note_no=$disp_id";
...
$sql="update disp_db set status=2 where disp_note_no=$disp_id and exit_date is null and status=1";
mysqli_query($link, $sql) or exit("Sql Error".mysqli_error($GLOBALS["___mysqli_ston"]));

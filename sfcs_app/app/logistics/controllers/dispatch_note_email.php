 ...
 <tr height=38 style='height:28.5pt'>
  ...
  <td class=xl662606></td>
		...
		while($sql_row=mysqli_fetch_array($sql_result))
		{
			...
			$sql1="select * from $pps.speed_del_dashboard where plant_code='$plant_code' and speed_schedule='$ship_schedule'";

...
<body>
	...
	<div class='panel-body'>
            ...
            <form action="<?= $action_url ?>" id="formentry" class="form-horizontal" role="form" method="POST" data-parsley-validate novalidate>
				...
				echo"<input id='section_name' type='text' class='form-control k-textbox float' data-role='text' placeholder='Section Name' name='section_name' value='' required='required' data-parsley-errors-container='#errId1'><span id='errId1' class='error'></span></div>";
...
<div class="col-md-4">
				<div class="form-group">
			    <label class="control-label control-label-left col-sm-3" for="ims_priority">IMS Priority Boxs<span class="req"> *</span></label>
			    <div class="controls col-sm-9">
                    
                <input id="ims_priority" type="text" class="form-control k-textbox float" data-role="text" placeholder="IMS Priority Box" name="ims_priority" value="<?php echo $ims_priority_boxs; ?>"  data-parsley-errors-container="#errId1"><span id="errId1" class="error"></span></div>
    ...
    <script>
		...
		<button id="btn_save" type="submit" class="btn btn-primary btn-lg" name="btn_save" style="margin-left: -667px;">Save</button></div></div></div></div>
                                    </div>

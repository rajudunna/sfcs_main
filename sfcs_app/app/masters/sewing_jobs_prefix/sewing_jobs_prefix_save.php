...
$sqlnewchange="ALTER TABLE `$mdm`.`tbl_sewing_job_prefix` ADD plant_code VARCHAR(10),created_user VARCHAR(10),created_at TIMESTAMP,updated_user VARCHAR(10),updated_at TIMESTAMP";  

...
<body>
	...
	<div class='panel-body'>
            ...
            <div class="col-md-4">
                ...
                <input id="reason_code" type="text" class="form-control k-textbox" data-role="text" required="required"  name="reason_code" value="<?php echo $rejct_code; ?>"  data-parsley-errors-container="#errId1"><span id="errId1" class="error"></span></div>

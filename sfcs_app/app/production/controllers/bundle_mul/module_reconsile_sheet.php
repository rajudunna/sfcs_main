...
<table border=0 cellpadding=0 cellspacing=0 width=1172 style='border-collapse:
 ...
 <tr height=20 style='height:15.0pt'>
  ...
  <td class=xl1532733></td>
  <td class=xl1532733></td>
  <td colspan=<?php echo sizeof($size_code)+1;?> class=xl6532733>Ratio</td>
  <td class=xl1532733></td>
  <td class=xl1532733></td>
 </tr>
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  ...
  <td class=xl1532733></td>
  <td class=xl1532733></td>
  <td class=xl6432733 style='border-top:none'>Size</td>
  <?php
	for($i=0;$i<sizeof($size_code);$i++)
	{
		?>
		<td class=xl6832733 width=59 style='border-top:none;border-left:none;  width:44pt'><?php echo $size_code[$i] ?> </td>
	  <?php
	}
  ?>
 ...
 <tr height=20 style='height:15.0pt'>
  ...
  <td class=xl1532733></td>
  <td class=xl1532733></td>
   <td class=xl6432733 style='border-top:none'>Quantity</td>
    <?php
	for($i=0;$i<sizeof($size_code);$i++)
	{
		
		?>
		<td class=xl6832733 width=59 style='border-top:none;border-left:none;  width:44pt'><?php echo $ratio[$i] ?></td>
	  <?php

...
{
	//alert("report");
	var ajax_url ="bundle_ticket_mrn.php?style="+document.mini_order_report.style.value;Ajaxify(ajax_url);
...
{
	//alert('test');
	var ajax_url ="bundle_ticket_mrn.php?style="+document.mini_order_report.style.value+"&schedule="+document.mini_order_report.schedule.value;
	Ajaxify(ajax_url);

...
<hr>
<form name="input" action="bundle_scan_ops.php" method="post" enctype="multipart/form data">
<table class="mytable1" border=0 cellpadding=0 cellspacing=0>
<tr>
	<th>Bundle Bar-code :</th>
	<td><input type="text" autocomplete="off" name="bundle_id" value="">
...
*/		
	...
	{
		echo "<table border=1px><tr><th>S.no</th><th>Bundle Number</th><th>Operation</th><th>Quantity</th><th>Rejection</th><th colspan=2>Control</th></tr>";
		while($row=mysqli_fetch_array($sql_result1))
		{
			...
			else
			{
				if($operation_id==4)
				{
					...
					{
						echo "<td><a href=\"update_ops.php?id=$id&mod_id=$mod_id&bundle_id=$bundle&ops=1\" >Edit</a></td>";
					}
				}
				else
				{

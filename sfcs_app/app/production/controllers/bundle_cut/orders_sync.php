...
bai_orders_db.order_tid,
bai_orders_db.order_s_xs+bai_orders_db.order_s_s+bai_orders_db.order_s_m+bai_orders_db.order_s_l+bai_orders_db.order_s_xl+bai_orders_db.order_s_xxl+bai_orders_db.order_s_xxxl+bai_orders_db.order_s_s06+bai_orders_db.order_s_s08+bai_orders_db.order_s_s10+bai_orders_db.order_s_s12+bai_orders_db.order_s_s14+bai_orders_db.order_s_s16+bai_orders_db.order_s_s18+bai_orders_db.order_s_s20+bai_orders_db.order_s_s22+bai_orders_db.order_s_s24+bai_orders_db.order_s_s26+bai_orders_db.order_s_s28+bai_orders_db.order_s_s30 AS order_quantity,
plandoc_stat_log.order_tid,
SUM((plandoc_stat_log.p_xs+plandoc_stat_log.p_s+plandoc_stat_log.p_l+plandoc_stat_log.p_m++plandoc_stat_log.p_xl+plandoc_stat_log.p_xxl+plandoc_stat_log.p_xxxl+plandoc_stat_log.p_s06+plandoc_stat_log.p_s08+plandoc_stat_log.p_s10+plandoc_stat_log.p_s12+plandoc_stat_log.p_s14+plandoc_stat_log.p_s16+plandoc_stat_log.p_s18+plandoc_stat_log.p_s20+plandoc_stat_log.p_s22+plandoc_stat_log.p_s24+plandoc_stat_log.p_s26+plandoc_stat_log.p_s28+plandoc_stat_log.p_s30)*plandoc_stat_log.p_plies) AS plan_quantity,
bai_orders_db_confirm.bts_status
	FROM $bai_pro3.bai_orders_db_confirm as  bai_orders_db_confirm
	...
	WHERE bai_orders_db_confirm.bts_status<>2 AND plandoc_stat_log.order_tid=bai_orders_db_confirm.order_tid
	...
	if($check1>0)
	{
		while($r=mysqli_fetch_array($result))
		{
			...
			{
				$insertOrdersMaster="INSERT INTO `tbl_orders_master`(`ref_product_style`, `product_schedule`,`order_status`) VALUES ('".$style_id."','".$product_schedule."', 'OPEN')";
		...
		echo "<script>swal('Synchronization Completed','','success');</script>";
	}
	else
	{

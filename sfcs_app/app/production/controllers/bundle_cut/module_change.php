	...
	for($i=0;$i<sizeof($bundle_id);$i++)
	{
		...
		if($num_rows>0)
		{
			while($row1=mysqli_fetch_array($result1))
			{
				...
				{
					$sql33="update bundle_transactions set date_time='".$row2['date_time']."',operation_time='".$row2['operation_time']."',shift='".$row2['shift']."' where id='".$p_id."'";
					//echo $sql33."<br>";
					...
					$sql34="insert into bundle_transactions_20_repeat_change select * from bundle_transactions_20_repeat operation_id='".$operation_id."' and bundle_id='".$bundle_id[$i]."'";
					//echo $sql34."<br>";

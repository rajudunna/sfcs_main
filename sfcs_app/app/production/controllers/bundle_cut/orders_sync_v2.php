...
<div class="panel-heading">Orders Re-Synchronization</div>
<div class="panel-body">

<!---<div id="page_heading"><span style="float: left"><h3>Orders Re-Synchronization</h3></span><span style="float: right"><b>?</b>&nbsp;</span></div>--->
<?php 
...
<div class='col-md-3 col-sm-3 col-xs-12'>
			Schedule Number:
			<?php
			echo "<select id=\"sch\" name=\"sch\" onchange=\"secondbox();\" class=\"select2_single form-control\">";
...
<div class='col-md-3 col-sm-3 col-xs-12' style="margin-top: 16px;">			
			<input type="submit" value="Sync" name="show" class="btn btn-success">
</div>
<form>
<?php
if(isset($_POST['show']))
{
	...
	$sql="SELECT bai_orders_db_confirm.*,bai_orders_db_confirm.order_s_xs+bai_orders_db_confirm.order_s_s+bai_orders_db_confirm.order_s_m+bai_orders_db_confirm.order_s_l+bai_orders_db_confirm.order_s_xl+bai_orders_db_confirm.order_s_xxl+bai_orders_db_confirm.order_s_xxxl+bai_orders_db_confirm.order_s_s06+bai_orders_db_confirm.order_s_s08+bai_orders_db_confirm.order_s_s10+bai_orders_db_confirm.order_s_s12+bai_orders_db_confirm.order_s_s14+bai_orders_db_confirm.order_s_s16+bai_orders_db_confirm.order_s_s18+bai_orders_db_confirm.order_s_s20+bai_orders_db_confirm.order_s_s22+bai_orders_db_confirm.order_s_s24+bai_orders_db_confirm.order_s_s26+bai_orders_db_confirm.order_s_s28+bai_orders_db_confirm.order_s_s30 AS confirm_order_quantity,
bai_orders_db.order_tid,bai_orders_db.order_s_xs+bai_orders_db.order_s_s+bai_orders_db.order_s_m+bai_orders_db.order_s_l+bai_orders_db.order_s_xl+bai_orders_db.order_s_xxl+bai_orders_db.order_s_xxxl+bai_orders_db.order_s_s06+bai_orders_db.order_s_s08+bai_orders_db.order_s_s10+bai_orders_db.order_s_s12+bai_orders_db.order_s_s14+bai_orders_db.order_s_s16+bai_orders_db.order_s_s18+bai_orders_db.order_s_s20+bai_orders_db.order_s_s22+bai_orders_db.order_s_s24+bai_orders_db.order_s_s26+bai_orders_db.order_s_s28+bai_orders_db.order_s_s30 AS order_quantity,plandoc_stat_log.order_tid,
SUM((plandoc_stat_log.p_xs+plandoc_stat_log.p_s+plandoc_stat_log.p_l+plandoc_stat_log.p_m++plandoc_stat_log.p_xl+plandoc_stat_log.p_xxl+plandoc_stat_log.p_xxxl+plandoc_stat_log.p_s06+plandoc_stat_log.p_s08+plandoc_stat_log.p_s10+plandoc_stat_log.p_s12+plandoc_stat_log.p_s14+plandoc_stat_log.p_s16+plandoc_stat_log.p_s18+plandoc_stat_log.p_s20+plandoc_stat_log.p_s22+plandoc_stat_log.p_s24+plandoc_stat_log.p_s26+plandoc_stat_log.p_s28+plandoc_stat_log.p_s30)*plandoc_stat_log.p_plies) AS plan_quantity,bai_orders_db_confirm.bts_status	FROM $bai_pro3.bai_orders_db_confirm as  bai_orders_db_confirm
	LEFT JOIN $bai_pro3.bai_orders_db  as bai_orders_db ON bai_orders_db.order_tid=bai_orders_db_confirm.order_tid
	LEFT JOIN $bai_pro3.plandoc_stat_log as plandoc_stat_log ON plandoc_stat_log.order_tid=bai_orders_db_confirm.order_tid
	WHERE bai_orders_db_confirm.order_del_no='".$scheudle_no."' AND plandoc_stat_log.order_tid=bai_orders_db_confirm.order_tid
	GROUP BY bai_orders_db_confirm.order_tid,bai_orders_db_confirm.order_col_des";
	...
	if($check1>0)
	{
		while($r=mysqli_fetch_array($result))
		{
			...
			{
				$select_ignore_check="select product_style from `$brandix_bts`.`tbl_orders_style_ref` where product_style='$style_code'";
				$result_insert_check=mysql_query($select_ignore_check,$link) or ("Sql error".mysql_error());
			...
			if($color_query>0)
			{
				...
				while($l=mysqli_fetch_array($result7))
				{
					...
					$select_insert_check="select doc_num from $brandix_bts.tbl_cut_master where doc_num='$doc_num'";
					$result_insert_one=mysql_query($select_insert_check,$link) or ("Sql error".mysql_error());
		...
		echo "<script>swal('Synchronization Completed','','success');</script></h2>";
	}
	else
	{
		echo "<script>swal('We did not Find Any New Lay plan','','warning');</script>";
	}	
}	

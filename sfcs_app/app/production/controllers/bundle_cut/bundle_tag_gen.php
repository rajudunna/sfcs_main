...
{
	//alert("report");
	window.location.href ="../mini_order_report/bundle_tag_gen.php?style="+document.mini_order_report.style.value
}

function secondbox()
{
	//alert('test');
	window.location.href ="../mini_order_report/bundle_tag_gen.php?style="+document.mini_order_report.style.value+"&schedule="+document.mini_order_report.schedule.value
}
...
<body>
<div id="page_heading"><span style="float: left"><h3>Binding Tag Generation</h3></span><span style="float: right"><b>?</b>&nbsp;</span></div>
...
if(isset($_POST['submit']))
{
	...
	$sql_result=mysqli_query($link, $sql) or exit("Sql Error2".mysqli_error($GLOBALS["___mysqli_ston"]));
	echo "<table border=1px><tr><th>Color</th><th>Cut No</th><th>Control</th></tr>";
	while($sql_row=mysqli_fetch_array($sql_result))
	{
		//echo $cutno."<br>";
		...
		echo "<tr><td>".$color."</td>";
		echo "<td>".$cut_code."</td>";
		echo "<td><a href=\"bundle_tag_gen_print.php?order_tid=$order_tid&doc_no=$doc_no&col_code=$color_code\" target=\"_blank\">Click Here to print</a></td></tr>";
	}
	echo "</table>";

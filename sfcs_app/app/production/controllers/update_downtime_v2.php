...
if($rest<=$dout){
	...
	$sql1="insert into $pps.hout(out_date,out_time,team,qty,status,remarks,plant_code,created_user,created_at) VALUES ('$odate','$otime','$team','$sout','3','downtime','$plantcode','$username','".date('Y-m-d')."')";

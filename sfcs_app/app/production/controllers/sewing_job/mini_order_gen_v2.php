	...
	if($status == '' || $status == '1')
	{
		...
		//{
			...
			while($row1=mysqli_fetch_array($result1))
			{
				...
				//echo $diff_qty."=".$cut_alloc."-".$order_qty_col_size."<br>";
				//echo $ex_cut_status."<br>";
				if($ex_cut_status=='1')
				{
		...
		// {
			...
			// echo "<script>var url = '".getFullURLLevel($_GET['r'],'sewing_job_create.php',0,'N')."';					

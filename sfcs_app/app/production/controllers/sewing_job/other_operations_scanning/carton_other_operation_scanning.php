        ...
        <div class='col-sm-12'>
            <div class='col-lg-6 col-sm-12'>
                <input type='text' id='changed_rej' name='changed_rej' hidden='true'>
                    ...
                    <center><label>Carton Number</label></center>
                        <input type="text" id="carton_number" onkeyup="validateQty1(event,this);" value='<?= $carton_no ?>' class="form-control" required placeholder="Scan the Cut Job..." <?php echo $read_only_job_no;?>/>
                    </div>
        ...
        <div class='panel panel-primary'  id="maindiv">
            ...
            <form action="index.php?r=<?php echo $_GET['r']?>" name= "smartform" method="post" id="smartform">
                <div class='panel-body'>
                    ...
                    <input type="hidden" name="carton_number" id="hid_job">
	...
	$.ajax({
			...
			{	
                ...
                if(response['status']){
					...
					document.getElementById('carton_number').value = '';
				}else if(data){
					$('#dynamic_table1').html('');

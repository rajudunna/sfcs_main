        ...
        if($check_output==1)
        {
            ...
            $output = $present_row['otp'];
                ...
                if($output==1)
                {
                    ...
                    $ims_update="update $pms.ims_log set ims_mod_no='$module',updated_user='$username',updated_at=NOW() where pac_tid='$barcode_number' and operation_id='$operation_code_ims' and plant_code='$plant_code'";
                    ...
                    $insert_log="insert into $pts.module_transfer_track (username,bundle_number,operation_code,from_module,to_module,time,plant_code,created_user,updated_user) values ('$user','$barcode_number','$ops_code','$from_module','$module',NOW(),'$plant_code','$username','$username')";

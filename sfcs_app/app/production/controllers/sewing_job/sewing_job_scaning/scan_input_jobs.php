...
$(document).ready(function() 
{
	...
	$.ajax({
			...
			{	
				...
				var doc_status = response['docket_status'];
				var cut_reported_qty = response['cut_reported_qty'];
				...
				else if(data)
				{
					...
					for(var i=0;i<data.length;i++)
					{
						...
						else
						{
							...
							status = '<font color="red">Cut Quantity Reporting Not Done</font>';
						}

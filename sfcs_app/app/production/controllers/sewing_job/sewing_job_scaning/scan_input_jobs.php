        ...
        <div class='panel panel-primary'>
            ...
            <form action="index.php?r=<?php echo $_GET['r']?>" name= "smartform" method="post" id="smartform">
                <div class='panel-body'>
                        ...
                        <div id ="dynamic_table1" style="overflow-x: scroll">
                        </div>
                </div>
            </form>
            </div>

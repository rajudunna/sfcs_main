...
<?php
                if(isset($_POST['showdetails']))
				{
					...
					echo "<tr class='success'>
						...
						$getbundledata="Select style,schedule,operation_id,size_title,docket_number,color From $brandix_bts.bundle_creation_data where bundle_number = '$barcodeno' and operation_id='$operation'";
						//echo $getbundledata;
						...
						if(mysqli_num_rows($check_data_qry_result)>0)
						{

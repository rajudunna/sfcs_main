				...
				else if($b_op_id == $output_ops_code)
				{
					...
					if($input_ops_code == $operation_out_code)
					{
						...
						if($result_searching_query_in_imslog->num_rows > 0)
						{
			                ...
			                //For 900 Operation
                            $get_qty_details1="select sum(if(operation_id = $input_ops_code,recevied_qty,0)) as input,sum(if(operation_id = $output_ops_code,recevied_qty,0)) as output,sum(if(operation_id = $output_ops_code,rejected_qty,0)) as output_rej From $brandix_bts.bundle_creation_data where  bundle_number=$b_tid[$i]";
						   ...
						   if($input_qty1 == $output_qty1)
                           {
	                        ...
	                        {	                            
	                            ...
	                            if($bundle_status == 1 && $ims_removal_flag == 1 && $line_out_check == 1)
	                            {

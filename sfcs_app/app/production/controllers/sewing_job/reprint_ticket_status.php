...
if(isset($_POST['show']))
{
	...
	if($no_rows>0)
	{
		$sql="insert into $pps.re_print_table(bundle_id,emp_id,module_id,shift,user_name,remark,plant_code,created_user,updated_user) values('".$bundle."','".$emp_no."','".$module."','".$shift."','".$username."','".$remark."','".$plant_code."','".$username."','".$username."')";
		//echo $sql."<br>";

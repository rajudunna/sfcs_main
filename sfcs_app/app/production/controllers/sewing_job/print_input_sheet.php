			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">	
					...
					<?php
						...
						$sql="select distinct input_job_no as job, type_of_sewing from $bai_pro3.packing_summary_input where order_del_no in ($schedule) and pac_seq_no=$seq_no order by  order_col_des,acutno*1,input_job_no*1";
						// echo $sql."<br>";

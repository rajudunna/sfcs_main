                            ...
                            echo "<div class='row'>
                                <table class='table table-bordered'>";
                                    ...
                                    while($sql_row=mysqli_fetch_array($sql_result))
                                    {
                                        ...
                                        $query1="select * from $bai_pro3.packing_summary_input where order_del_no=\"".$schedule."\" and input_job_no='".$sql_row['input_job_no']."' AND ( mrn_status IS NULL OR mrn_status =0) ";

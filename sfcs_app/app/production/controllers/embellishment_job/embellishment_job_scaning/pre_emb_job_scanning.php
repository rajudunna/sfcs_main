...
<form method ='POST' id='myform'>
	<div class="panel panel-primary">
		<div class="panel-heading"><strong>Embellishment/Sewing Job Scanning</strong></div>
			...
			<div class="row">
				<div class="col-md-2">
                    ...
                    <select class='form-control' name = 'operation'  id = 'operation' required>
                        ...
                        <?php 
                        $sqly="SELECT operation_code,operation_name FROM $pms.operation_mapping where plant_code = '$plant_code' and is_active=1 and (operation_category='sewing' or operation_category='embellishment')";
                ...
                <div class="col-md-1">
                    <br>
                    <button type='submit' value='Continue with Sewing' name='SUBMIT' class='btn btn-primary' formaction='<?=$url.'&type=sewing';?>' style="margin-top: 4px;;margin-left: 150px;">Continue with Sewing</button>
                </div>
			</div>
		</div>
	</div>

...
<script>
    ...
    function reload_style(){
        ...
        var ajax_url =url1+"&style_id="+style_id;Ajaxify(ajax_url);

    }
	function reload_schedule(){
        var schedule_num=document.getElementById('schedule_id').value;
		var style_id=document.getElementById('style_id').value;
        var ajax_url =url1+"&style_id="+style_id+"&schedule="+schedule_num;Ajaxify(ajax_url);
	...
	function reload_color(){
        ...
        var ajax_url =url1+"&style_id="+style_id+"&schedule="+schedule_num+"&color="+encodeURI(color_num);Ajaxify(ajax_url);
	...
	function reload_cut(){
        ...
        var ajax_url =url1+"&style_id="+style_id+"&schedule="+schedule_num+"&color="+encodeURI(color_num)+"&cut="+cut_num;
		Ajaxify(ajax_url);

	...
	<body> 
		<div class="container-fluid">			
			<div class="panel panel-info"> 
            	<div class="panel-heading"><strong>Scan a Bundle</strong></div>
                <div class="panel-body">
                    ...
                    <form action="apicalls1.php" method="POST" id="panelform">
                        ...
                        <div class="form-group col-md-4" id="opr">
                            <label>Operation:(Original Qty : <span id="original_qty"></span> , Send Qty : <span id="sen_qty"></span>)<span style="color:red">*</span></label>

...
for($i=0;$i<sizeof($mod_names);$i++)
{
	...
	// $sql222="Select  jumper from $bai_pro.pro_atten_jumper where atten_id='".$date."".$mod_names[$i]."' and module='$mod_names[$i]'";
	...
	// $sql22="update $bai_pro.pro_attendance set present='".$_POST['pra'.$i]."',absent='".$_POST['aba'.$i]."',shift='".$shift."' where date='".$date."' and module='$mod_names[$i]'";
	// echo $sql22."</br>";
	// mysqli_query($link, $sql22) or exit("Sql Errorf".mysqli_error($GLOBALS["___mysqli_ston"]));

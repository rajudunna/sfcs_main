...
if($_GET['some'] == 'bundle_no')
{
		...
		while($sql_row = $sql_result1->fetch_assoc())
		{
			...
			$bcd_root_query = "SELECT * from $brandix_bts.bundle_creation_data where style='$style' and schedule ='$schedule' and color='$color' and bundle_number= '$bundle_number' and operation_id in ($op_codes) limit 1";

...
//   echo $table_temp; 
//     $table.=$table_temp; 
$table_temp="<td colspan=1 class=xl9726424 style='background-color:#5A5A5A' style='border-right:1.0pt solid black;  border-left:none'>A=".round($act_clock_hrs1,0)."</td>";
echo $table_temp;
$table.=$table_temp;
$table_temp="<td colspan=1 class=xl9726424 style='background-color:#5A5A5A' style='border-right:1.0pt solid black;  border-left:none'>P=".round(($pclha_total+$pclhb_total),0)."</td>";
echo $table_temp;
$table.=$table_temp;

							...
							<tbody>
								<tr>
									...
									<?php
										for ($i=0; $i < sizeof($time_display); $i++)
										{
											$row=echo_title("$pps.hout","SUM(qty)","out_date='$frdate' AND plant_code='$plantcode' and rep_start_time = TIME('".$start_time[$i]."') AND rep_end_time = TIME('".$end_time[$i]."') and team",$team,$link);

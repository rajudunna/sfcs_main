							...
							<div class="table-area">
								<table class="table table-bordered">
									...
									<?php
										...
										$groupedSecQry = "SELECT distinct monthly_production_plan.group FROM $pps.monthly_production_plan LEFT JOIN $pps.monthly_production_plan_upload_log upload_log ON upload_log.monthly_production_plan_upload_log_id = monthly_production_plan.monthly_production_plan_upload_log_id where  plant_code = '" . $plantCode . "' and planned_date ='".$frdate."'";

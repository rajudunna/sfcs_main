...
<?php
		if(isset($_GET['submit']))
		{
			...
			while($row=mysqli_fetch_array($res))
			{
				...
				// $sql6="SELECT out_time,qty,status FROM $pps.hout where out_date='$frdate' AND team='$team'";
				// $res6=mysqli_query($link,$sql6);
				
				// $sql6="SELECT $query remarks FROM $pps.hout where out_date='$frdate' AND team='$team'";
				// echo $sql6.'<br><br>';
				// $res6=mysqli_query($link,$sql6);

...
?>
	...
	<?php
		if (isset($_GET['show']))
		{
			...
			$message .= '
			<div class="panel panel-primary" id="demo_container">
					...
					<div class="col-md-12">
										...
										<table class="table table-bordered">
											...
											<tbody>';
												...
												while($Sec=mysqli_fetch_array($section_result))
												{
													...
													$message .= "<tr style=\"background-color:lightgreen;font-weight: bold; border-bottom:2px solid black; border-top:2px solid black;\">
												...
												$message .= "<tr style=\"background-color:green;color:white;font-weight: bold; border-bottom:2px solid black; border-top:2px solid black;\">
						...
						<div class="col-md-7">
							<div class="panel panel-info">
								...
								<div class="panel-body">
									<div id = "container23" style = "width: auto; height: 400px; margin: 0 auto"></div>';
					...
					<div class="col-md-12">
						<div class="panel panel-info">
							<div class="panel-heading text-center">Hourly Plan Vs Actual SAH for '.$selected_date.'</div>
									<div class="panel-body">
										<div id = "sah_container23" style = "height: 400px; width:auto;"></div>';
										$message .="<script language = \"JavaScript\">
										         $(document).ready(function() {
										            var title = {
										               text: '".$selected_date."'   
										            ...
										            $('#sah_container23').highcharts(json);
										         });
										      </script>";
							$message .='</div>
						</div>

...
?>
             <?php 
                $sql="SELECT id,ref_no,response_status,m3_bulk_tran_id FROM $bai_pro3.`m3_transactions` WHERE response_status='fail' AND m3_trail_count=4";
               ...
               echo '<div class="panel panel-primary">
                      <div class="panel-heading">M3 Bulk Opration Reconfirm Report</div>
                        <div class="panel-body">
                           <div class="table-responsive">
                                 ...
                                 <tr><th>Ref No</th><th>Response Status</th>';
                ...
                while($sql_row=mysqli_fetch_array($sql_result))
                {
                    ...
                    echo "<tr><td>".$sql_row['ref_no']."</td><td>".$sql_row['response_status']."</td>";

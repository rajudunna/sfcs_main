...
?>
             <?php 
              ...
              $sql="SELECT `bai_pro3`.`m3_transactions`.id,m3_trail_count,response_status,op_des,`bai_pro3`.`m3_transactions`.mo_no,m3_bulk_tran_id,style,SCHEDULE,color,size,quantity,`brandix_bts`.`transactions_log`.`response_message` FROM `bai_pro3`.`m3_transactions`  
               ...
               echo '<div class="panel panel-primary">
                      ...
                      <form action="'.getFullURLLevel($_GET["r"],"m3_transcations_reconfirm_report.php","0","N").'" name="print" method="POST">                    
                        ...
                        <div class="table-responsive">
                                 ...
                                 <tr><th>S.No</th><th>Mo No</th><th>Style</th><th>Schedule</th><th>Color</th><th>Size</th><th>Quantity</th><th>Operation</th><th>Failed Reason</th><th>Failed Count</th><th>Response Status</th>';
                ...
                while($sql_row=mysqli_fetch_array($sql_result))
                {
                    ...
                    echo "<tr><td>".$i++."</td><td>".$sql_row['mo_no']."</td><td>".$style."</td><td>".$schedule."</td><td>".$color."</td><td>".$size."</td><td>".$mo_qty."</td><td>".$op_dec."</td><td>".$remarks."</td><td>".$trail_count."</td><td>".$response."</td>";

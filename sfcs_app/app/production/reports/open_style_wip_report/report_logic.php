    ...
    // echo date("Y-m-d H:i:s")."-3st <br/>";
     ...
     while ($row1 = $get_style_data_result->fetch_assoc())
     {
        ...
        $operation[] = $row1['operation_code'];
         ...
         $asum_str = rtrim($asum,' + ');
        //To get Order Qty
        $get_order_qty="select ($asum_str) as order_qty,co_no from $bai_pro3.bai_orders_db_confirm where order_style_no='$style' and order_del_no='$schedule' and order_col_des='$color' ";
        //echo  $get_order_qty;

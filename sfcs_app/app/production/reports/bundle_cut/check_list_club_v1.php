...
$style_id=echo_title("$brandix_bts.tbl_cut_master","style_id","doc_num",$doc_no,$link);
$style=echo_title("$brandix_bts.tbl_orders_style_ref","product_style","id",$style_id,$link);
$mini_order_num=echo_title("$brandix_bts.tbl_miniorder_data","mini_order_num","docket_number in (".implode(",",$doc_id).") and 1",1,$link);
$cut_code1=echo_title("$brandix_bts.tbl_cut_master","col_code","doc_num",$doc_no,$link);	
$cut_num1=echo_title("$brandix_bts.tbl_cut_master","cut_num","doc_num",$doc_no,$link);	
//$cut_code=;

...
$sql="select time_stamp from $brandix_bts_uat.snap_session_track where session_id=1";
...
$sql="SELECT tbl_orders_style_ref_product_style FROM $brandix_bts_uat.view_set_snap_1_tbl where bundle_transactions_20_repeat_operation_id!=5 GROUP BY tbl_orders_style_ref_product_style";

//new
$sql="SELECT DISTINCT tbl_orders_style_ref_product_style FROM $brandix_bts_uat.view_set_snap_1_tbl WHERE bundle_transactions_20_repeat_operation_id!=5";
...
while($sql_row=mysqli_fetch_array($sql_result))
{
	...
	echo "<li><a href=\"redirect_page.php?filterstyle=$style\" target=\"main1\">".$style."</a></li>";
...
<iframe id="mainFrame" name="main1" class="ui-layout-center" 

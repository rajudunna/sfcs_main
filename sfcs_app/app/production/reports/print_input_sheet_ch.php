            ...
            <?php
                ...
                while($sql_row=mysqli_fetch_array($result))
                {
                    ...
                    while($sql_row1=mysqli_fetch_array($result1))
                    {
                        ...
                        $sql55="SELECT ims_date,ims_doc_no,ims_color,ims_mod_no,ims_size,SUM(ims_qty) AS ims_qty,SUM(ims_pro_qty) AS ims_pro_qty FROM  $bai_pro3.ims_combine WHERE ims_schedule=".$sql_row1["del_no"]." AND input_job_no_ref='".$sql_row["job"]."' GROUP BY ims_doc_no,ims_color,ims_size ORDER BY ims_mod_no,ims_date,ims_color";
                        //echo $sql5."<br>";

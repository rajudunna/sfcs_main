...
//default theme
  ...
  $('#clickme').cluetip({activation: 'click', sticky: true, width: 850});
...
//For current project
  ...
  sticky: true,	
  ajaxCache:false,
  closeText: '<img src="/scripts/jquery-cluetip-master/demo/cross.png" alt="close" width="16" height="16" />',
  closePosition: 'title', arrows: true, cursor: 'pointer'
  });

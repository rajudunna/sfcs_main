...
function know_sfcs_job_no($doc_no)
{
	...
	$sql_result=mysqli_query($link_secure_m3or, $sql) or exit("Sql Error1a".mysqli_error($GLOBALS["___mysqli_ston"]));
	while($sql_row=mysqli_fetch_array($sql_result))
	{
...
function know_m3_size_code($schedule,$sfcs_size,$sfcs_color)
{
	...
	if($title_flag==0)
	{
		...
		$sql_result=mysqli_query($link_secure_m3or, $sql) or exit("Sql Error3a$sql".mysqli_error($GLOBALS["___mysqli_ston"]));
		while($sql_row=mysqli_fetch_array($sql_result))
		{
...
function construct_connection()
{
	...
	mysqli_select_db($link_secure_m3or, $database_secure_m3or) or die();
...
function m3_bulk_or_fn($sfcs_date ,$sfcs_style ,$sfcs_schedule ,$sfcs_color ,$sfcs_size ,$sfcs_doc_no ,$sfcs_qty ,$sfcs_reason ,$sfcs_job_no ,$sfcs_mod_no ,$sfcs_shift ,$m3_op_des)
{
	...
	$sql_result=mysqli_query($link_secure_m3or, $sql) or exit("Sql Error4a".mysqli_error($GLOBALS["___mysqli_ston"]));
...
function output_validation_old($operation,$schedule,$color,$size,$reported_qty,$tid_ref,$username)
{
	...
	*/
	...
	//echo $sql;
	$sql_result=mysqli_query($link_secure_m3or, $sql) or exit("Sql Error10a".mysqli_error($GLOBALS["___mysqli_ston"]));
	while($sql_row=mysqli_fetch_array($sql_result))
	{
	...
	*/
	...
	//echo $sql;
	$sql_result=mysqli_query($link_secure_m3or, $sql) or exit("Sql Error13a".mysqli_error($GLOBALS["___mysqli_ston"]));
	while($sql_row=mysqli_fetch_array($sql_result))
	{
...
function output_validation($operation,$schedule,$color,$size,$reported_qty,$tid_ref,$username)
{
	...
	//echo $sql;
	$sql_result=mysqli_query($link_secure_m3or, $sql) or exit("Sql Error14a".mysqli_error($GLOBALS["___mysqli_ston"]));
	while($sql_row=mysqli_fetch_array($sql_result))
	{
...
function m3_cpk_validation_multi_color($operation,$prevoperation,$schedule,$color,$cartonid,$reportqty)
{
	...
	//echo $sql1."<br>";
	$sql_result1=mysqli_query($link_secure_m3or, $sql1) or exit("Sql Error3".mysqli_error($GLOBALS["___mysqli_ston"]));
	while($sql_row1=mysqli_fetch_array($sql_result1))
	{
	...
	//echo $sql;
	$sql_result=mysqli_query($link_secure_m3or, $sql) or exit("Sql Error1".mysqli_error($GLOBALS["___mysqli_ston"]));
	while($sql_row=mysqli_fetch_array($sql_result))
	{
		$sfcs_qty=$sql_row['sfcs_qty'];	
		$sfcs_qty_filtered=$sql_row['sfcs_qty_filtered'];	
	...
	//echo $sql;
	$sql_result=mysqli_query($link_secure_m3or, $sql) or exit("Sql Error2".mysqli_error($GLOBALS["___mysqli_ston"]));
	while($sql_row=mysqli_fetch_array($sql_result))
	{
		$prev_sfcs_qty=$sql_row['sfcs_qty'];	
		$prev_sfcs_qty_filtered=$sql_row['sfcs_qty_filtered'];	

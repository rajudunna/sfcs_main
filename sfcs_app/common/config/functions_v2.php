...
function getDocketDetails($sub_po,$plantcode,$docket_type){
  ...
  function getWorkstations($department,$plantcode){
    ...
    $qry_workstations="SELECT workstation_id,workstation_description FROM $pms.workstation WHERE is_active=1 AND plant_code='$plantcode' AND workstation_type_id IN ('$workstations')";

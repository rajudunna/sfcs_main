...
<?php
	...
	for($j=0;$j<sizeof($carton_nodes);$j++)
	{
			...
			$html.= '<div><table><tr><td colspan=3><barcode code="'.leading_zeros($node_detail[3],8).'" type="C39"/ height="0.80" size="1.1" text="1">
			</td><td align="middle"><b>'.$node_detail[3].'</b></td></tr>';
			$html.= '<tr><td style="line-height: 15px; vertical-align: middle; border-spacing: 0; font-size:16px;">Style:</td>
			<td style="line-height: 15px; vertical-align: middle; border-spacing: 0; font-size: 16px;"class="new_td">'.str_pad($style, 15, " ", STR_PAD_RIGHT).'</td>
			<td style="line-height: 15px; vertical-align: middle; border-spacing: 0; font-size: 16px;">Schedule:</td>
			<td style="line-height: 15px; vertical-align: middle; border-spacing: 0; font-size: 16px;" class="new_td3"> '.str_pad($delivery, 15, " ", STR_PAD_RIGHT).'
			</td></tr>';
			$html.= '<tr><td style="line-height: 15px; vertical-align: middle; border-spacing: 0; font-size: 16px;">Color:  </td>
			<td style="line-height: 15px; vertical-align: middle; border-spacing: 0; font-size: 16px; white-space: nowrap;">'.$node_detail[5].'</td></tr>';
			$html.= '<tr><td style="font-size: 16px;">Assort:&nbsp;&nbsp;</td><td style="font-size: 16px;" style="white-space: nowrap"><b>'.$packing_method." ".$node_detail[1].'('.$node_detail[7].')'.'</b></td>
			<td style="font-size: 16px;">Packs: </td><td style="font-size: 16px;"><b>'.substr($node_detail[6],0,2).'</b></td>
			<td style="font-size: 16px;">SRP: </td><td style="font-size: 16px;"><b> '.$string.'</b></td></tr>';
			$html.= '<tr><td style="font-size: 16px;">Jobs: </td><td style="font-size: 16px;"><b>'.implode(",",$job_nos).'</b></td>
			<td style="font-size: 16px;">Size:</td><td style="font-size: 16px;"><b> '.$node_detail[4].'</b></td>
			<td style="font-size: 16px;">Qty: </td><td style="font-size: 16px;"><b>'.$node_detail[2].'</b></td></tr>';
			$html.= '<tr><td style="font-size: 16px;">Carton:</td><td style="font-size: 16px;"><b>'.$node_detail[0].'</b></td><td style="font-size: 16px;">MPO:</td><td style=""><b>'.$mpo.'</b></td></tr>';
			$html.= '<tr><td style="font-size: 16px;">CO No.:</td><td style="font-size: 16px;"><b>'.$co_no.'</b></td></tr>';
			$html.= '</table></div>';

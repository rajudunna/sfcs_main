...
$sql1="update inspection_complaint_db set mail_status=1 where complaint_no=\"$comaplint_no\"";
...
$sql2="SELECT SUM(qty_rec) AS rec_qty,COUNT(tid) as rolls,SUM(ref5) AS insp_qty FROM store_in WHERE lot_no IN (".$reject_lot_no.")";	
//echo $sql2."<br>";
...
<table border=0 cellpadding=0 cellspacing=0 width=981 class=xl655354315
 ...
 {	
	...
	if($rows > 0)
	{
		$src="http://baitestsrv01:8080/projects/beta/rm_projects/bai_rm_pj1/mpdf50/examples/Wrong1.jpg";
		//$src="X";
	}
	else
	{
		$src="http://baitestsrv01:8080/projects/beta/rm_projects/bai_rm_pj1/mpdf50/examples/Wrong2.jpg";
		//$src=" ";
	}
...
email_attachment('brandixalerts@schemaxtech.com,praveenv@brandix.com,shivajiv@brandix.com','Dear All, <br/><br/> Please Find The Material Complaint Sheet. <br></br>'.$htmlstr.' <br/><br/> Message Sent Via: http://bainet', 'Material Complaint Sheet Ref# '.$ref_no.'','Shop Floor System Alert', 'ictsysalert@brandix.com','Claim_PDF_Files/'.$ref_no.'.pdf', $default_filetype='application/zip');

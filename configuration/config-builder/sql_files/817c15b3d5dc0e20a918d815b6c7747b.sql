...
MySQL - 5.5.5-10.1.28-MariaDB : Database - bai_pro3
*********************************************************************
*/
...
/*Database structure for database `bai_pro3` */
...
CREATE TABLE `allocate_stat_log` (
  ...
  PRIMARY KEY (`tid`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=latin1 COMMENT='To track ration detail of cut job';
...
CREATE TABLE `bai_qms_db` (
  ...
  `doc_no` varchar(20) NOT NULL COMMENT 'Docket_Reference',
  `location_id` varchar(30) NOT NULL COMMENT 'FK_Location map ID',
  `input_job_no` varchar(25) DEFAULT NULL,
  `operation_id` int(11) DEFAULT NULL COMMENT 'M3 Operation ID',
  PRIMARY KEY (`qms_tid`),
  KEY `sscs` (`qms_style`,`qms_schedule`,`qms_color`,`qms_size`),
  KEY `qms_size` (`qms_style`,`qms_size`),
  KEY `qms_color` (`qms_schedule`,`qms_color`),
...
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=latin1 COMMENT='To update quality/rejection details';
...
CREATE TABLE `bai_qms_db_deleted` (
  ...
  `doc_no` varchar(20) NOT NULL COMMENT 'Docket_Reference',
  `location_id` varchar(30) NOT NULL COMMENT 'FK_Location map ID',
  `input_job_no` varchar(30) DEFAULT NULL,
  `operation_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`qms_tid`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1 COMMENT='To track deleted Trans of QMS table';
...
) ENGINE=InnoDB AUTO_INCREMENT=4063 DEFAULT CHARSET=latin1 COMMENT='To maintain order details (categories) to prepare Lay Plan';
...
CREATE TABLE `cuttable_stat_log` (
  ...
  `cuttable_wastage` decimal(11,3) NOT NULL,
  PRIMARY KEY (`tid`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1 COMMENT='To track actual cuttable % on order quantities';
...
CREATE TABLE `ims_log_bc` (
  ...
  `team_comm` varchar(250) NOT NULL COMMENT 'For updating Team Comments in Production',
  PRIMARY KEY (`tid_ref`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Clone of IMS_log for deleted entries.';
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1 COMMENT='To track marker details';
...
) ENGINE=MyISAM AUTO_INCREMENT=29 DEFAULT CHARSET=latin1 COMMENT='Login details for CMS';
...
CREATE TABLE `menu_index` (
  ...
  PRIMARY KEY (`list_id`)
) ENGINE=InnoDB AUTO_INCREMENT=193 DEFAULT CHARSET=latin1 COMMENT='Manufacturing Menu Details';
...
CREATE TABLE `pac_stat_log_input_job` (
  ...
  `packing_mode` int(11) DEFAULT NULL,
  `old_size` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`tid`),
  KEY `doc_no` (`doc_no`)
) ENGINE=MyISAM AUTO_INCREMENT=10 DEFAULT CHARSET=latin1;

/*Table structure for table `pac_stat_log_input_job_archive` */

DROP TABLE IF EXISTS `pac_stat_log_input_job_archive`;

CREATE TABLE `pac_stat_log_input_job_archive` (
  `tid` double NOT NULL AUTO_INCREMENT,
  `doc_no` double DEFAULT NULL,
  `size_code` varchar(30) DEFAULT NULL,
  `carton_act_qty` int(11) DEFAULT NULL,
...
CREATE TABLE `schedule_oprations_master` (
  ...
  PRIMARY KEY (`tid`)
) ENGINE=InnoDB AUTO_INCREMENT=23435 DEFAULT CHARSET=latin1;
...
/*!50106 CREATE DEFINER=`root`@`localhost` EVENT `call_sync_dump` ON SCHEDULE EVERY 5 MINUTE STARTS '2017-05-30 05:00:00' ON COMPLETION NOT PRESERVE ENABLE DO BEGIN
...
/*!50003 CREATE DEFINER=`baiall`@`%` FUNCTION `fn_act_pac_qty`(in_ims_doc_no BIGINT,in_ims_size VARCHAR(100)) RETURNS int(11)
BEGIN
...
/*!50003 CREATE DEFINER=`baiall`@`%` FUNCTION `fn_act_ship_qty`(in_sch_no BIGINT) RETURNS int(11)
BEGIN
	DECLARE var_name INT;
	  SET var_name = 0;
...
/*!50003 CREATE DEFINER=`baiall`@`%` FUNCTION `fn_buyer_division_sch`(in_schedule VARCHAR(100)) RETURNS varchar(100) CHARSET latin1
BEGIN
...
/*!50003 CREATE DEFINER=`baiall`@`%` FUNCTION `fn_ims_log_bk_output`(in_ims_doc_no BIGINT,in_ims_size VARCHAR(100)) RETURNS int(11)
BEGIN
	DECLARE var_name INT;
	  SET var_name = 0;
	   SET SESSION TRANSACTION ISOLATION LEVEL READ UNCOMMITTED ;
...
/*!50003 CREATE DEFINER=`baiall`@`%` FUNCTION `fn_ims_log_output`(in_ims_doc_no BIGINT,in_ims_size VARCHAR(100)) RETURNS int(11)
BEGIN
	DECLARE var_name INT;
	  SET var_name = 0;
	  SET SESSION TRANSACTION ISOLATION LEVEL READ UNCOMMITTED ;
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `fn_know_binding_con`(ord_id VARCHAR(200)) RETURNS float(10,4)
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `input_job_input_status`(in_job_rand_no_ref VARCHAR(30)) RETURNS varchar(10) CHARSET latin1
    DETERMINISTIC
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `fn_savings_per_cal`(dat date,cat_re BIGINT,sch VARCHAR(300),col VARCHAR(300)) RETURNS float(10,2)
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `stripSpeciaChars`(`dirty_string` VARCHAR(2048),allow_space TINYINT,allow_number TINYINT,allow_alphabets TINYINT,no_trim TINYINT) RETURNS varchar(2048) CHARSET utf8
BEGIN
/**
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `packing_pending_schedules` AS (select distinct `packing_summary`.`order_del_no` AS `order_del_no` from `packing_summary` where ((`packing_summary`.`status` <> 'DONE') or isnull(`packing_summary`.`status`))) */;

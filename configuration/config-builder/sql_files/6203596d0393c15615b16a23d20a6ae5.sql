...
MySQL - 5.5.5-10.1.28-MariaDB : Database - central_administration
*********************************************************************
*/
...
/*Database structure for database `central_administration` */
...
/*!50003 CREATE DEFINER=`baiall`@`%` PROCEDURE `GetFunctionDetails`()
BEGIN
...
/*!50003 CREATE DEFINER=`baiall`@`%` PROCEDURE `list_function`()
begin
DECLARE v_fn_id int;

...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 23, 2018 at 07:11 AM
...
('localhost', 'root', '*DF38236351329C9928C24150ED7A290C0B3AF7EF', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', '', '', '', 0, 0, 0, 0, '', '', 'N', 'N', '', '0.000000'),

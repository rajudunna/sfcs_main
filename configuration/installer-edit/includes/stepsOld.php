...
$steps = array(
	...
	array(
		...
		'fields' => array(
			...
			array(
				'type' => 'info',
				'value' => '<span style="color:red">As part of this demonstration, create "cache" folder and an empty "config.php" file in the same directory where you have installed PHP Wizard Script.</span>',
			),
			...
			array(
				...
				'items' => array(
					'php_version' => array('>=5.6', 'PHP Version'), // PHP version must be at least 5.6

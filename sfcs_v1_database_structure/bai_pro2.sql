...
CREATE TABLE `db_update_log` (
  ...
  PRIMARY KEY (`tid`)
) ENGINE=MyISAM AUTO_INCREMENT=25168 DEFAULT CHARSET=latin1;
...
CREATE TABLE `fr_data` (
  ...
  PRIMARY KEY (`fr_id`)
) ENGINE=InnoDB AUTO_INCREMENT=49652 DEFAULT CHARSET=latin1;
...
CREATE TABLE `print_track` (
  ...
  PRIMARY KEY (`tid`)
) ENGINE=MyISAM AUTO_INCREMENT=4999 DEFAULT CHARSET=latin1;
...
CREATE TABLE `shipment_plan` (
  ...
  KEY `ssc_code` (`ssc_code`)
) ENGINE=MyISAM AUTO_INCREMENT=72206547 DEFAULT CHARSET=latin1;
...
/*!50106 CREATE EVENT `buyer_codes_event` ON SCHEDULE EVERY 1 DAY STARTS '2018-03-22 12:41:00' ON COMPLETION NOT PRESERVE ENABLE DO BEGIN

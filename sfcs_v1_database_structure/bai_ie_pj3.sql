...
MySQL - 5.5.16 : Database - bai_ie_pj3
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`bai_ie_pj3` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='storing machie names and  brand names here';
...
CREATE TABLE `main_locker` (
  ...
  `location_id_ref` varchar(45) NOT NULL,
  `notification_limit` varchar(45) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='summary of all the spare parts details of machine  ';
...
CREATE TABLE `main_locker_stock_in` (
  ...
  `stat` int(11) NOT NULL COMMENT 'Status',
  PRIMARY KEY (`sno`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='spare parts stock insertion details';
...
CREATE TABLE `tbl_location` (
  ...
  `location_desc` varchar(45) NOT NULL COMMENT 'location/locker description',
  `location_status` varchar(45) NOT NULL COMMENT 'location of box/locker status',

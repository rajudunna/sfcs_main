...
DROP TABLE IF EXISTS `bai_pro2`.`buyer_codes`;

CREATE TABLE `bai_pro2`.`buyer_codes` (
...
DROP TABLE IF EXISTS `bai_pro2`.`downtime_reason`;

CREATE TABLE `bai_pro2`.`downtime_reason` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `bai_pro2`.`fr_data`;

CREATE TABLE `bai_pro2`.`fr_data` (
...
DROP TABLE IF EXISTS `bai_pro2`.`hourly_downtime`;

CREATE TABLE `bai_pro2`.`hourly_downtime` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `bai_pro2`.`hout`;

CREATE TABLE `bai_pro2`.`hout` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `bai_pro2`.`members`;

CREATE TABLE `bai_pro2`.`members` (
...
DROP TABLE IF EXISTS `bai_pro2`.`movex_styles`;

CREATE TABLE `bai_pro2`.`movex_styles` (
...
DROP TABLE IF EXISTS `bai_pro2`.`movex_styles_backup`;

CREATE TABLE `bai_pro2`.`movex_styles_backup` (
...
DROP TABLE IF EXISTS `bai_pro2`.`movex_styles_copy`;

CREATE TABLE `bai_pro2`.`movex_styles_copy` (
  `movex_style` varchar(200) NOT NULL,
  `style_id` varchar(200) DEFAULT NULL,
  `mod_count` int(11) NOT NULL,
  PRIMARY KEY (`movex_style`)
...
DROP TABLE IF EXISTS `bai_pro2`.`order_status_buffer`;

CREATE TABLE `bai_pro2`.`order_status_buffer` (
...
DROP TABLE IF EXISTS `bai_pro2`.`shipment_plan`;

CREATE TABLE `bai_pro2`.`shipment_plan` (
  `tid` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `bai_pro2`.`shipment_plan_summ`;

CREATE TABLE `bai_pro2`.`shipment_plan_summ` (
  `ssc_code` varchar(500) NOT NULL,
  `style_no` varchar(200) NOT NULL,
  `schedule_no` varchar(200) NOT NULL,
  `color` varchar(200) NOT NULL,
...
DROP TABLE IF EXISTS `bai_pro2`.`ssc_code_filter`;

CREATE TABLE `bai_pro2`.`ssc_code_filter` (
  `ssc_code` varchar(200) NOT NULL,
  PRIMARY KEY (`ssc_code`),
  KEY `ssc_code` (`ssc_code`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
DROP TABLE IF EXISTS `bai_pro2`.`style_status`;

CREATE TABLE `bai_pro2`.`style_status` (
...
DROP TABLE IF EXISTS `bai_pro2`.`style_status_summ`;

CREATE TABLE `bai_pro2`.`style_status_summ` (
  `ssc_code` varchar(500) NOT NULL,
  `style` varchar(200) NOT NULL,
  `sch_no` varchar(200) NOT NULL,
  `color` varchar(200) NOT NULL,
...
DROP TABLE IF EXISTS `bai_pro2`.`tbl_mini_plant_master`;

CREATE TABLE `bai_pro2`.`tbl_mini_plant_master` (
...
DROP TABLE IF EXISTS `bai_pro2`.`user`;

CREATE TABLE `bai_pro2`.`user` (
  `uid` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `bai_pro2`.`user_type`;

CREATE TABLE `bai_pro2`.`user_type` (
  `tid` int(11) NOT NULL AUTO_INCREMENT,

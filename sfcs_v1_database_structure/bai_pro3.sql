...
CREATE TABLE `allocate_stat_log` (
  ...
  PRIMARY KEY (`tid`)
) ENGINE=MyISAM AUTO_INCREMENT=255 DEFAULT CHARSET=latin1 COMMENT='To track ration detail of cut job';
...
) ENGINE=MyISAM AUTO_INCREMENT=96 DEFAULT CHARSET=latin1 COMMENT='To update quality/rejection details';
...
CREATE TABLE `carton_qty_chart` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=17 DEFAULT CHARSET=latin1 COMMENT='Matrix \n\nto refer standard carton qty';
...
) ENGINE=InnoDB AUTO_INCREMENT=969893 DEFAULT CHARSET=latin1 COMMENT='To maintain order details (categories) to prepare Lay Plan';
...
CREATE TABLE `cuttable_stat_log` (
  ...
  PRIMARY KEY (`tid`)
) ENGINE=InnoDB AUTO_INCREMENT=94 DEFAULT CHARSET=latin1 COMMENT='To track actual cuttable % on order quantities';
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1 COMMENT='To track dispatch details';
...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=latin1 COMMENT='Table to track IMS';
...
) ENGINE=InnoDB AUTO_INCREMENT=131 DEFAULT CHARSET=latin1 COMMENT='To track marker details';
...
CREATE TABLE `mix_temp_desti` (
  ...
  PRIMARY KEY (`mix_tid`)
) ENGINE=InnoDB AUTO_INCREMENT=90 DEFAULT CHARSET=latin1 COMMENT='For Temp table for Order Mixing (for Job Level)';
...
CREATE TABLE `mix_temp_source` (
  ...
  `cutno` int(10) NOT NULL,
  PRIMARY KEY (`mix_tid`)
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=latin1 COMMENT='For Temp table for Order Mixing (for Job Level)';
...
CREATE TABLE `pac_stat_log` (
  ...
  KEY `tid` (`tid`)
) ENGINE=InnoDB AUTO_INCREMENT=274632 DEFAULT CHARSET=latin1 COMMENT='Carton details table';
...
CREATE TABLE `pac_stat_log_backup` (
  ...
  `scan_user` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`tid`)
) ENGINE=InnoDB AUTO_INCREMENT=5325 DEFAULT CHARSET=latin1 COMMENT='Clone of Pac_Stat_Log for system backup after shipment';
...
CREATE TABLE `pac_stat_log_input_job` (
  ...
  PRIMARY KEY (`tid`),
  KEY `doc_no` (`doc_no`)
) ENGINE=MyISAM AUTO_INCREMENT=4187 DEFAULT CHARSET=latin1;
...
CREATE TABLE `schedule_oprations_master` (
  ...
  PRIMARY KEY (`tid`)
) ENGINE=InnoDB AUTO_INCREMENT=24240 DEFAULT CHARSET=latin1;
...
/*!50106 CREATE DEFINER=`baiall`@`%` EVENT `call_sync_dump` ON SCHEDULE EVERY 5 MINUTE STARTS '2017-05-30 05:00:00' ON COMPLETION NOT PRESERVE ENABLE DO BEGIN
...
/*!50003 CREATE DEFINER=`baiall`@`%` FUNCTION `fn_know_binding_con`(ord_id VARCHAR(200)) RETURNS float(10,4)
BEGIN
...
/*!50003 CREATE DEFINER=`baiall`@`%` FUNCTION `fn_savings_per_cal`(dat date,cat_re BIGINT,sch VARCHAR(300),col VARCHAR(300)) RETURNS float(10,2)
BEGIN
...
/*!50003 CREATE DEFINER=`baiall`@`%` FUNCTION `input_job_input_status`(in_job_rand_no_ref VARCHAR(30)) RETURNS varchar(10) CHARSET latin1
    DETERMINISTIC
BEGIN
...
/*!50003 CREATE DEFINER=`baiall`@`%` FUNCTION `stripSpeciaChars`(`dirty_string` VARCHAR(2048),allow_space TINYINT,allow_number TINYINT,allow_alphabets TINYINT,no_trim TINYINT) RETURNS varchar(2048) CHARSET utf8
BEGIN
/**
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`baiall`@`%` SQL SECURITY DEFINER VIEW `packing_pending_schedules` AS (select distinct `packing_summary`.`order_del_no` AS `order_del_no` from `packing_summary` where ((`packing_summary`.`status` <> 'DONE') or isnull(`packing_summary`.`status`))) */;

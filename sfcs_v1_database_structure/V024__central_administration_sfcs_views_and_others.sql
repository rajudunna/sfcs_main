...
DROP TABLE IF EXISTS `central_administration_sfcs`.`veiw_menu_matrix`;
...
DROP TABLE IF EXISTS `central_administration_sfcs`.`view_menu`;
...
DROP TABLE IF EXISTS `central_administration_sfcs`.`view_menu_role`;

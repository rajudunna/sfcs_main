    ...
    <div class="nav_menu">
        <nav>
            ...
            <div class="nav navbar-nav navbar-right" ng-app="brand">
                <div class="col-md-6" ng-controller="menu as menuctrl"><br />
                    <div class='col-sm-6 ' ng-cloak>
                        ...
                        <div class='col-sm-12' style="position: absolute;background: white;margin-top: -10px;z-index:999" ng-show='menuctrl.ss'>
                            <h4>Suggestions : {{menuctrl.ser_box}}</h4>
                            <hr />
                ...
                <div class='col-md-6 pull-right text-center'>
                    ...
                    <li class=""><b class='text-info' data-toggle="modal" data-target="#myModalab" style="cursor: pointer;" title="Permissions List">
                    <u data-toggle="tooltip" title="Permissions List" data-placement="bottom"><i class="fas fa-suitcase"></i>&nbsp;<?= getrbac_user()['role'] ?></u></b>
                </li>                        
                        <li class=""> <h4 style="margin:0px"  class='text-danger'><i class="fas fa-user"></i>&nbsp;<?= getrbac_user()['uname'] ?></h4>
                    </li>
                        <li class=""><font class='text-primary' style="margin-top:-15px;font-size: 16px">&nbsp;<b><?= strtoupper(get_plant_name()) ?></b></font></li>
                                ...
                                <table class="table table-bordered table-fixed">
                                    ...
                                    <tbody>
                                        ...
                                        <tr ng-repeat="data in access_mapping_data | filter: search" valign="center">
                                            ...
                                            <td>
                                                <h2 ng-repeat="perms in data.permission_names track by $index"><span class="label label-success">{{perms}}</span><br></h2>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>

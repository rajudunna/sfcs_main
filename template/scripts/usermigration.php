...
$sql_menus = "SELECT menu_pid,link_description FROM tbl_menu_list WHERE link_location!='' order by menu_pid limit 100,400";
...
while($menu_rs = mysqli_fetch_array($res_menus)){
    //======== insert menu data ======================
    $ins_menu = "INSERT INTO `rbac_role_menu`(menu_pid,menu_description,roll_id) VALUES ('".$menu_rs['menu_pid']."','".$menu_rs['link_description']."',3)";

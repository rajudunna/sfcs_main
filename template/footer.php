...
<footer class="footer navbar">
    ...
    <div class="container-fluid clearfix">
        ...
        <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">&copy; 2018
            <a href="http://www.bootstrapdash.com/" target="_blank"><b>XAPPERL</b></a>. All rights reserved.
        </span>

        <span class="text-muted d-block text-right text-sm-right d-sm-inline-block">Powered by&nbsp;
        <img src="images/schemax-logo.png"></i>
        </span>
